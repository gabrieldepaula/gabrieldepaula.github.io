...
"use strict";Component.define("page-salvar-acesso",function(a,e){var o=$(a),b=o.find("form"),u=new URLSearchParams(window.location.search).get("id");u?$.get(base_api+"acesso/pesquisar",function(a){$(a).each(function(a,e){u==e.id&&(b.find('[name="movimento"]').val(e.movimento),e.morador&&($('[name="tipo"]').val("morador"),$('[name="morador"]').val(e.morador.id),b.find(".tipo, .select-morador").removeClass("d-none").addClass("d-block")),e.visitante&&($('[name="tipo"]').val("visitante"),$('[name="visitante"]').val(e.visitante.id),b.find(".tipo, .select-visitante").removeClass("d-none").addClass("d-block")),e.prestadorServico&&($('[name="tipo"]').val("prestadorservico"),$('[name="prestadorservico"]').val(e.prestadorServico.id),b.find(".tipo, .select-prestadorservico").removeClass("d-none").addClass("d-block")),e.corretor&&($('[name="tipo"]').val("corretor"),$('[name="corretor"]').val(e.corretor.id),b.find(".tipo, .select-corretor").removeClass("d-none").addClass("d-block")),e.entregador&&($('[name="tipo"]').val("entregador"),$('[name="entregador"]').val(e.entregador.id),b.find(".tipo, .select-entregador").removeClass("d-none").addClass("d-block")),o.find(".page-title").text("Editar acesso #"+u),b.prepend('<input type="hidden" name="id" value="'+e.id+'">'),b.find("select").attr("disabled",!1))})}):b.find("select").attr("disabled",!1),b.on("submit",function(a){a.preventDefault();var e,o=b.find('[name="movimento"]'),r=b.find('[name="tipo"]'),i=b.find('[name="morador"]'),n=b.find('[name="visitante"]'),s=b.find('[name="prestadorservico"]'),d=b.find('[name="corretor"]'),t=b.find('[name="entregador"]'),l=null,p=null,c=null,v=null,m=null;u&&(e=b.find('[name="id"]')),b.find("form-control").removeClass("is-invalid"),b.find(".invalid-feedback").remove();var f=!0;switch(0==o.val().length&&(o.addClass("is-invalid"),o.parents(".form-group").append('<p class="invalid-feedback">Este campo é obrigatório</p>'),f=!1),0==r.val().length&&(r.addClass("is-invalid"),r.parents(".form-group").append('<p class="invalid-feedback">Este campo é obrigatório</p>'),f=!1),r.val()){case"morador":0==i.val().length?(i.addClass("is-invalid"),i.parents(".form-group").append('<p class="invalid-feedback">Este campo é obrigatório</p>'),f=!1):l=i.val();break;case"visitante":0==n.val().length?(n.addClass("is-invalid"),n.parents(".form-group").append('<p class="invalid-feedback">Este campo é obrigatório</p>'),f=!1):p=n.val();break;case"prestadorservico":0==s.val().length?(s.addClass("is-invalid"),s.parents(".form-group").append('<p class="invalid-feedback">Este campo é obrigatório</p>'),f=!1):c=s.val();break;case"corretor":0==d.val().length?(d.addClass("is-invalid"),d.parents(".form-group").append('<p class="invalid-feedback">Este campo é obrigatório</p>'),f=!1):v=d.val();break;case"entregador":0==t.val().length?(t.addClass("is-invalid"),t.parents(".form-group").append('<p class="invalid-feedback">Este campo é obrigatório</p>'),f=!1):m=t.val();break;default:f=!1}if(f){var g={id:u?e.val():null,morador:l,visitante:p,prestadorServico:c,corretor:v,entregador:m,movimento:o.val()};$.ajax({url:base_api+"acesso/salvar",type:"POST",dataType:"json",contentType:"application/json",data:JSON.stringify(g),success:function(){alert("Acesso "+(u?"atualizado":"cadastrado")+" com sucesso."),window.location.href=base},error:function(){alert("Erro na requisição."),window.location.href=window.location.href}})}})});
