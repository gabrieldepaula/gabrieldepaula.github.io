...
var _gsScope="undefined"!=typeof module&&module.exports&&"undefined"!=typeof global?global:this||window;(_gsScope._gsQueue||(_gsScope._gsQueue=[])).push(function(){"use strict";_gsScope._gsDefine("plugins.CSSPlugin",["plugins.TweenPlugin","TweenLite"],function(n,L){var x,P,T,d,I=function(){n.call(this,"css"),this._overwriteProps.length=0,this.setRatio=I.prototype.setRatio},f=_gsScope._gsDefine.globals,g={},t=I.prototype=new n("css");(t.constructor=I).version="1.19.0",I.API=2,I.defaultTransformPerspective=0,I.defaultSkewType="compensated",I.defaultSmoothOrigin=!0,t="px",I.suffixMap={top:t,right:t,bottom:t,left:t,width:t,height:t,fontSize:t,padding:t,margin:t,perspective:t,lineHeight:""};var k,y,m,j,_,M,X,S,e,r,R=/(?:\-|\.|\b)(\d|\.|e\-)+/g,F=/(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g,v=/(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi,p=/(?![+-]?\d*\.?\d+|[+-]|e[+-]\d+)[^0-9]/g,Y=/(?:\d|\-|\+|=|#|\.)*/g,A=/opacity *= *([^)]*)/i,b=/opacity:([^;]*)/i,a=/alpha\(opacity *=.+?\)/i,O=/^(rgb|hsl)/,o=/([A-Z])/g,l=/-([a-z])/gi,w=/(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi,h=function(t,e){return e.toUpperCase()},u=/(?:Left|Right|Width)/i,c=/(M11|M12|M21|M22)=[\d\-\.e]+/gi,C=/progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i,z=/,(?=[^\)]*(?:\(|$))/gi,N=/[\s,\(]/i,V=Math.PI/180,D=180/Math.PI,B={},W=document,i=function(t){return W.createElementNS?W.createElementNS("http://www.w3.org/1999/xhtml",t):W.createElement(t)},Z=i("div"),E=i("img"),s=I._internals={_specialProps:g},q=navigator.userAgent,$=(e=q.indexOf("Android"),r=i("a"),m=-1!==q.indexOf("Safari")&&-1===q.indexOf("Chrome")&&(-1===e||3<Number(q.substr(e+8,1))),_=m&&Number(q.substr(q.indexOf("Version/")+8,1))<6,j=-1!==q.indexOf("Firefox"),(/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(q)||/Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(q))&&(M=parseFloat(RegExp.$1)),!!r&&(r.style.cssText="top:1px;opacity:.55;",/^0.55/.test(r.style.opacity))),H=function(t){return A.test("string"==typeof t?t:(t.currentStyle?t.currentStyle.filter:t.style.filter)||"")?parseFloat(RegExp.$1)/100:1},G=function(t){window.console&&console.log(t)},U="",Q="",J=function(t,e){var r,i,s=(e=e||Z).style;if(void 0!==s[t])return t;for(t=t.charAt(0).toUpperCase()+t.substr(1),r=["O","Moz","ms","Ms","Webkit"],i=5;-1<--i&&void 0===s[r[i]+t];);return 0<=i?(U="-"+(Q=3===i?"ms":r[i]).toLowerCase()+"-",Q+t):null},K=W.defaultView?W.defaultView.getComputedStyle:function(){},tt=I.getStyle=function(t,e,r,i,s){var n;return $||"opacity"!==e?(!i&&t.style[e]?n=t.style[e]:(r=r||K(t))?n=r[e]||r.getPropertyValue(e)||r.getPropertyValue(e.replace(o,"-$1").toLowerCase()):t.currentStyle&&(n=t.currentStyle[e]),null==s||n&&"none"!==n&&"auto"!==n&&"auto auto"!==n?n:s):H(t)},et=s.convertToPixels=function(t,e,r,i,s){if("px"===i||!i)return r;if("auto"===i||!r)return 0;var n,a,o,l=u.test(e),f=t,p=Z.style,h=r<0,c=1===r;if(h&&(r=-r),c&&(r*=100),"%"===i&&-1!==e.indexOf("border"))n=r/100*(l?t.clientWidth:t.clientHeight);else{if(p.cssText="border:0 solid red;position:"+tt(t,"position")+";line-height:0;","%"!==i&&f.appendChild&&"v"!==i.charAt(0)&&"rem"!==i)p[l?"borderLeftWidth":"borderTopWidth"]=r+i;else{if(a=(f=t.parentNode||W.body)._gsCache,o=L.ticker.frame,a&&l&&a.time===o)return a.width*r/100;p[l?"width":"height"]=r+i}f.appendChild(Z),n=parseFloat(Z[l?"offsetWidth":"offsetHeight"]),f.removeChild(Z),l&&"%"===i&&!1!==I.cacheWidths&&((a=f._gsCache=f._gsCache||{}).time=o,a.width=n/r*100),0!==n||s||(n=et(t,e,r,i,!0))}return c&&(n/=100),h?-n:n},rt=s.calculateOffset=function(t,e,r){if("absolute"!==tt(t,"position",r))return 0;var i="left"===e?"Left":"Top",s=tt(t,"margin"+i,r);return t["offset"+i]-(et(t,e,parseFloat(s),s.replace(Y,""))||0)},it=function(t,e){var r,i,s,n={};if(e=e||K(t,null))if(r=e.length)for(;-1<--r;)-1!==(s=e[r]).indexOf("-transform")&&Ct!==s||(n[s.replace(l,h)]=e.getPropertyValue(s));else for(r in e)-1!==r.indexOf("Transform")&&At!==r||(n[r]=e[r]);else if(e=t.currentStyle||t.style)for(r in e)"string"==typeof r&&void 0===n[r]&&(n[r.replace(l,h)]=e[r]);return $||(n.opacity=H(t)),i=qt(t,e,!1),n.rotation=i.rotation,n.skewX=i.skewX,n.scaleX=i.scaleX,n.scaleY=i.scaleY,n.x=i.x,n.y=i.y,Nt&&(n.z=i.z,n.rotationX=i.rotationX,n.rotationY=i.rotationY,n.scaleZ=i.scaleZ),n.filters&&delete n.filters,n},st=function(t,e,r,i,s){var n,a,o,l={},f=t.style;for(a in r)"cssText"!==a&&"length"!==a&&isNaN(a)&&(e[a]!==(n=r[a])||s&&s[a])&&-1===a.indexOf("Origin")&&("number"!=typeof n&&"string"!=typeof n||(l[a]="auto"!==n||"left"!==a&&"top"!==a?""!==n&&"auto"!==n&&"none"!==n||"string"!=typeof e[a]||""===e[a].replace(p,"")?n:0:rt(t,a),void 0!==f[a]&&(o=new _t(f,a,f[a],o))));if(i)for(a in i)"className"!==a&&(l[a]=i[a]);return{difs:l,firstMPT:o}},nt={width:["Left","Right"],height:["Top","Bottom"]},at=["marginLeft","marginRight","marginTop","marginBottom"],ot=function(t,e,r){if("svg"===(t.nodeName+"").toLowerCase())return(r||K(t))[e]||0;if(t.getBBox&&Wt(t))return t.getBBox()[e]||0;var i=parseFloat("width"===e?t.offsetWidth:t.offsetHeight),s=nt[e],n=s.length;for(r=r||K(t,null);-1<--n;)i-=parseFloat(tt(t,"padding"+s[n],r,!0))||0,i-=parseFloat(tt(t,"border"+s[n]+"Width",r,!0))||0;return i},lt=function(t,e){if("contain"===t||"auto"===t||"auto auto"===t)return t+" ";null!=t&&""!==t||(t="0 0");var r,i=t.split(" "),s=-1!==t.indexOf("left")?"0%":-1!==t.indexOf("right")?"100%":i[0],n=-1!==t.indexOf("top")?"0%":-1!==t.indexOf("bottom")?"100%":i[1];if(3<i.length&&!e){for(i=t.split(", ").join(",").split(","),t=[],r=0;r<i.length;r++)t.push(lt(i[r]));return t.join(",")}return null==n?n="center"===s?"50%":"0":"center"===n&&(n="50%"),("center"===s||isNaN(parseFloat(s))&&-1===(s+"").indexOf("="))&&(s="50%"),t=s+" "+n+(2<i.length?" "+i[2]:""),e&&(e.oxp=-1!==s.indexOf("%"),e.oyp=-1!==n.indexOf("%"),e.oxr="="===s.charAt(1),e.oyr="="===n.charAt(1),e.ox=parseFloat(s.replace(p,"")),e.oy=parseFloat(n.replace(p,"")),e.v=t),e||t},ft=function(t,e){return"function"==typeof t&&(t=t(S,X)),"string"==typeof t&&"="===t.charAt(1)?parseInt(t.charAt(0)+"1",10)*parseFloat(t.substr(2)):parseFloat(t)-parseFloat(e)||0},pt=function(t,e){return"function"==typeof t&&(t=t(S,X)),null==t?e:"string"==typeof t&&"="===t.charAt(1)?parseInt(t.charAt(0)+"1",10)*parseFloat(t.substr(2))+e:parseFloat(t)||0},ht=function(t,e,r,i){var s,n,a,o,l;return"function"==typeof t&&(t=t(S,X)),(o=null==t?e:"number"==typeof t?t:(s=360,n=t.split("_"),a=((l="="===t.charAt(1))?parseInt(t.charAt(0)+"1",10)*parseFloat(n[0].substr(2)):parseFloat(n[0]))*(-1===t.indexOf("rad")?1:D)-(l?0:e),n.length&&(i&&(i[r]=e+a),-1!==t.indexOf("short")&&(a%=s)!==a%180&&(a=a<0?a+s:a-s),-1!==t.indexOf("_cw")&&a<0?a=(a+3599999999640)%s-(a/s|0)*s:-1!==t.indexOf("ccw")&&0<a&&(a=(a-3599999999640)%s-(a/s|0)*s)),e+a))<1e-6&&-1e-6<o&&(o=0),o},ct={aqua:[0,255,255],lime:[0,255,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,255],navy:[0,0,128],white:[255,255,255],fuchsia:[255,0,255],olive:[128,128,0],yellow:[255,255,0],orange:[255,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[255,0,0],pink:[255,192,203],cyan:[0,255,255],transparent:[255,255,255,0]},ut=function(t,e,r){return 255*(6*(t=t<0?t+1:1<t?t-1:t)<1?e+(r-e)*t*6:t<.5?r:3*t<2?e+(r-e)*(2/3-t)*6:e)+.5|0},xt=I.parseColor=function(t,e){var r,i,s,n,a,o,l,f,p,h,c;if(t)if("number"==typeof t)r=[t>>16,t>>8&255,255&t];else{if(","===t.charAt(t.length-1)&&(t=t.substr(0,t.length-1)),ct[t])r=ct[t];else if("#"===t.charAt(0))4===t.length&&(t="#"+(i=t.charAt(1))+i+(s=t.charAt(2))+s+(n=t.charAt(3))+n),r=[(t=parseInt(t.substr(1),16))>>16,t>>8&255,255&t];else if("hsl"===t.substr(0,3))if(r=c=t.match(R),e){if(-1!==t.indexOf("="))return t.match(F)}else a=Number(r[0])%360/360,o=Number(r[1])/100,i=2*(l=Number(r[2])/100)-(s=l<=.5?l*(o+1):l+o-l*o),3<r.length&&(r[3]=Number(t[3])),r[0]=ut(a+1/3,i,s),r[1]=ut(a,i,s),r[2]=ut(a-1/3,i,s);else r=t.match(R)||ct.transparent;r[0]=Number(r[0]),r[1]=Number(r[1]),r[2]=Number(r[2]),3<r.length&&(r[3]=Number(r[3]))}else r=ct.black;return e&&!c&&(i=r[0]/255,s=r[1]/255,n=r[2]/255,l=((f=Math.max(i,s,n))+(p=Math.min(i,s,n)))/2,f===p?a=o=0:(h=f-p,o=.5<l?h/(2-f-p):h/(f+p),a=f===i?(s-n)/h+(s<n?6:0):f===s?(n-i)/h+2:(i-s)/h+4,a*=60),r[0]=a+.5|0,r[1]=100*o+.5|0,r[2]=100*l+.5|0),r},dt=function(t,e){var r,i,s,n=t.match(gt)||[],a=0,o=n.length?"":t;for(r=0;r<n.length;r++)i=n[r],a+=(s=t.substr(a,t.indexOf(i,a)-a)).length+i.length,3===(i=xt(i,e)).length&&i.push(1),o+=s+(e?"hsla("+i[0]+","+i[1]+"%,"+i[2]+"%,"+i[3]:"rgba("+i.join(","))+")";return o+t.substr(a)},gt="(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3}){1,2}\\b";for(t in ct)gt+="|"+t+"\\b";gt=new RegExp(gt+")","gi"),I.colorStringFilter=function(t){var e,r=t[0]+t[1];gt.test(r)&&(e=-1!==r.indexOf("hsl(")||-1!==r.indexOf("hsla("),t[0]=dt(t[0],e),t[1]=dt(t[1],e)),gt.lastIndex=0},L.defaultStringFilter||(L.defaultStringFilter=I.colorStringFilter);var yt=function(t,e,n,a){if(null==t)return function(t){return t};var o,l=e?(t.match(gt)||[""])[0]:"",f=t.split(l).join("").match(v)||[],p=t.substr(0,t.indexOf(f[0])),h=")"===t.charAt(t.length-1)?")":"",c=-1!==t.indexOf(" ")?" ":",",u=f.length,x=0<u?f[0].replace(R,""):"";return u?o=e?function(t){var e,r,i,s;if("number"==typeof t)t+=x;else if(a&&z.test(t)){for(s=t.replace(z,"|").split("|"),i=0;i<s.length;i++)s[i]=o(s[i]);return s.join(",")}if(e=(t.match(gt)||[l])[0],i=(r=t.split(e).join("").match(v)||[]).length,u>i--)for(;++i<u;)r[i]=n?r[(i-1)/2|0]:f[i];return p+r.join(c)+c+e+h+(-1!==t.indexOf("inset")?" inset":"")}:function(t){var e,r,i;if("number"==typeof t)t+=x;else if(a&&z.test(t)){for(r=t.replace(z,"|").split("|"),i=0;i<r.length;i++)r[i]=o(r[i]);return r.join(",")}if(i=(e=t.match(v)||[]).length,u>i--)for(;++i<u;)e[i]=n?e[(i-1)/2|0]:f[i];return p+e.join(c)+h}:function(t){return t}},mt=function(f){return f=f.split(","),function(t,e,r,i,s,n,a){var o,l=(e+"").split(" ");for(a={},o=0;o<4;o++)a[f[o]]=l[o]=l[o]||l[(o-1)/2>>0];return i.parse(t,a,s,n)}},_t=(s._setPluginRatio=function(t){this.plugin.setRatio(t);for(var e,r,i,s,n,a=this.data,o=a.proxy,l=a.firstMPT;l;)e=o[l.v],l.r?e=Math.round(e):e<1e-6&&-1e-6<e&&(e=0),l.t[l.p]=e,l=l._next;if(a.autoRotate&&(a.autoRotate.rotation=a.mod?a.mod(o.rotation,this.t):o.rotation),1===t||0===t)for(l=a.firstMPT,n=1===t?"e":"b";l;){if((r=l.t).type){if(1===r.type){for(s=r.xs0+r.s+r.xs1,i=1;i<r.l;i++)s+=r["xn"+i]+r["xs"+(i+1)];r[n]=s}}else r[n]=r.s+r.xs0;l=l._next}},function(t,e,r,i,s){this.t=t,this.p=e,this.v=r,this.r=s,i&&((i._prev=this)._next=i)}),vt=(s._parseToProxy=function(t,e,r,i,s,n){var a,o,l,f,p,h=i,c={},u={},x=r._transform,d=B;for(r._transform=null,B=e,i=p=r.parse(t,e,i,s),B=d,n&&(r._transform=x,h&&(h._prev=null,h._prev&&(h._prev._next=null)));i&&i!==h;){if(i.type<=1&&(u[o=i.p]=i.s+i.c,c[o]=i.s,n||(f=new _t(i,"s",o,f,i.r),i.c=0),1===i.type))for(a=i.l;0<--a;)l="xn"+a,u[o=i.p+"_"+l]=i.data[l],c[o]=i[l],n||(f=new _t(i,l,o,f,i.rxp[l]));i=i._next}return{proxy:c,end:u,firstMPT:f,pt:p}},s.CSSPropTween=function(t,e,r,i,s,n,a,o,l,f,p){this.t=t,this.p=e,this.s=r,this.c=i,this.n=a||e,t instanceof vt||d.push(this.n),this.r=o,this.type=n||0,l&&(this.pr=l,x=!0),this.b=void 0===f?r:f,this.e=void 0===p?r+i:p,s&&((this._next=s)._prev=this)}),bt=function(t,e,r,i,s,n){var a=new vt(t,e,r,i-r,s,-1,n);return a.b=r,a.e=a.xs0=i,a},Ot=I.parseComplex=function(t,e,r,i,s,n,a,o,l,f){r=r||n||"","function"==typeof i&&(i=i(S,X)),a=new vt(t,e,0,0,a,f?2:1,null,!1,o,r,i),i+="",s&&gt.test(i+r)&&(i=[r,i],I.colorStringFilter(i),r=i[0],i=i[1]);var p,h,c,u,x,d,g,y,m,_,v,b,O,w=r.split(", ").join(",").split(" "),P=i.split(", ").join(",").split(" "),T=w.length,M=!1!==k;for(-1===i.indexOf(",")&&-1===r.indexOf(",")||(w=w.join(" ").replace(z,", ").split(" "),P=P.join(" ").replace(z,", ").split(" "),T=w.length),T!==P.length&&(T=(w=(n||"").split(" ")).length),a.plugin=l,a.setRatio=f,p=gt.lastIndex=0;p<T;p++)if(u=w[p],x=P[p],(y=parseFloat(u))||0===y)a.appendXtra("",y,ft(x,y),x.replace(F,""),M&&-1!==x.indexOf("px"),!0);else if(s&&gt.test(u))b=")"+((b=x.indexOf(")")+1)?x.substr(b):""),O=-1!==x.indexOf("hsl")&&$,u=xt(u,O),x=xt(x,O),(m=6<u.length+x.length)&&!$&&0===x[3]?(a["xs"+a.l]+=a.l?" transparent":"transparent",a.e=a.e.split(P[p]).join("transparent")):($||(m=!1),O?a.appendXtra(m?"hsla(":"hsl(",u[0],ft(x[0],u[0]),",",!1,!0).appendXtra("",u[1],ft(x[1],u[1]),"%,",!1).appendXtra("",u[2],ft(x[2],u[2]),m?"%,":"%"+b,!1):a.appendXtra(m?"rgba(":"rgb(",u[0],x[0]-u[0],",",!0,!0).appendXtra("",u[1],x[1]-u[1],",",!0).appendXtra("",u[2],x[2]-u[2],m?",":b,!0),m&&(u=u.length<4?1:u[3],a.appendXtra("",u,(x.length<4?1:x[3])-u,b,!1))),gt.lastIndex=0;else if(d=u.match(R)){if(!(g=x.match(F))||g.length!==d.length)return a;for(h=c=0;h<d.length;h++)v=d[h],_=u.indexOf(v,c),a.appendXtra(u.substr(c,_-c),Number(v),ft(g[h],v),"",M&&"px"===u.substr(_+v.length,2),0===h),c=_+v.length;a["xs"+a.l]+=u.substr(c)}else a["xs"+a.l]+=a.l||a["xs"+a.l]?" "+x:x;if(-1!==i.indexOf("=")&&a.data){for(b=a.xs0+a.data.s,p=1;p<a.l;p++)b+=a["xs"+p]+a.data["xn"+p];a.e=b+a["xs"+p]}return a.l||(a.type=-1,a.xs0=a.e),a.xfirst||a},wt=9;for((t=vt.prototype).l=t.pr=0;0<--wt;)t["xn"+wt]=0,t["xs"+wt]="";t.xs0="",t._next=t._prev=t.xfirst=t.data=t.plugin=t.setRatio=t.rxp=null,t.appendXtra=function(t,e,r,i,s,n){var a=this,o=a.l;return a["xs"+o]+=n&&(o||a["xs"+o])?" "+t:t||"",r||0===o||a.plugin?(a.l++,a.type=a.setRatio?2:1,a["xs"+a.l]=i||"",0<o?(a.data["xn"+o]=e+r,a.rxp["xn"+o]=s,a["xn"+o]=e,a.plugin||(a.xfirst=new vt(a,"xn"+o,e,r,a.xfirst||a,0,a.n,s,a.pr),a.xfirst.xs0=0)):(a.data={s:e+r},a.rxp={},a.s=e,a.c=r,a.r=s),a):(a["xs"+o]+=e+(i||""),a)};var Pt=function(t,e){e=e||{},this.p=e.prefix&&J(t)||t,g[t]=g[this.p]=this,this.format=e.formatter||yt(e.defaultValue,e.color,e.collapsible,e.multi),e.parser&&(this.parse=e.parser),this.clrs=e.color,this.multi=e.multi,this.keyword=e.keyword,this.dflt=e.defaultValue,this.pr=e.priority||0},Tt=s._registerComplexSpecialProp=function(t,e,r){"object"!=typeof e&&(e={parser:r});var i,s=t.split(","),n=e.defaultValue;for(r=r||[n],i=0;i<s.length;i++)e.prefix=0===i&&e.prefix,e.defaultValue=r[i]||n,new Pt(s[i],e)},Mt=s._registerPluginProp=function(t){if(!g[t]){var l=t.charAt(0).toUpperCase()+t.substr(1)+"Plugin";Tt(t,{parser:function(t,e,r,i,s,n,a){var o=f.com.greensock.plugins[l];return o?(o._cssRegister(),g[r].parse(t,e,r,i,s,n,a)):(G("Error: "+l+" js file not loaded."),s)}})}};(t=Pt.prototype).parseComplex=function(t,e,r,i,s,n){var a,o,l,f,p,h,c=this.keyword;if(this.multi&&(z.test(r)||z.test(e)?(o=e.replace(z,"|").split("|"),l=r.replace(z,"|").split("|")):c&&(o=[e],l=[r])),l){for(f=l.length>o.length?l.length:o.length,a=0;a<f;a++)e=o[a]=o[a]||this.dflt,r=l[a]=l[a]||this.dflt,c&&(p=e.indexOf(c))!==(h=r.indexOf(c))&&(-1===h?o[a]=o[a].split(c).join(""):-1===p&&(o[a]+=" "+c));e=o.join(", "),r=l.join(", ")}return Ot(t,this.p,e,r,this.clrs,this.dflt,i,this.pr,s,n)},t.parse=function(t,e,r,i,s,n,a){return this.parseComplex(t.style,this.format(tt(t,this.p,T,!1,this.dflt)),this.format(e),s,n)},I.registerSpecialProp=function(t,l,f){Tt(t,{parser:function(t,e,r,i,s,n,a){var o=new vt(t,r,0,0,s,2,r,!1,f);return o.plugin=n,o.setRatio=l(t,e,i._tween,r),o},priority:f})},I.useSVGTransformAttr=m||j;var kt,Xt,St,Rt,Ft,Yt="scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),At=J("transform"),Ct=U+"transform",zt=J("transformOrigin"),Nt=null!==J("perspective"),Bt=s.Transform=function(){this.perspective=parseFloat(I.defaultTransformPerspective)||0,this.force3D=!(!1===I.defaultForce3D||!Nt)&&(I.defaultForce3D||"auto")},jt=window.SVGElement,Vt=function(t,e,r){var i,s=W.createElementNS("http://www.w3.org/2000/svg",t),n=/([a-z])([A-Z])/g;for(i in r)s.setAttributeNS(null,i.replace(n,"$1-$2").toLowerCase(),r[i]);return e.appendChild(s),s},Lt=W.documentElement,It=(Ft=M||/Android/i.test(q)&&!window.chrome,W.createElementNS&&!Ft&&(Xt=Vt("svg",Lt),Rt=(St=Vt("rect",Xt,{width:100,height:50,x:100})).getBoundingClientRect().width,St.style[zt]="50% 50%",St.style[At]="scaleX(0.5)",Ft=Rt===St.getBoundingClientRect().width&&!(j&&Nt),Lt.removeChild(Xt)),Ft),Dt=function(t,e,r,i,s,n){var a,o,l,f,p,h,c,u,x,d,g,y,m,_,v=t._gsTransform,b=Et(t,!0);v&&(m=v.xOrigin,_=v.yOrigin),(!i||(a=i.split(" ")).length<2)&&(c=t.getBBox(),a=[(-1!==(e=lt(e).split(" "))[0].indexOf("%")?parseFloat(e[0])/100*c.width:parseFloat(e[0]))+c.x,(-1!==e[1].indexOf("%")?parseFloat(e[1])/100*c.height:parseFloat(e[1]))+c.y]),r.xOrigin=f=parseFloat(a[0]),r.yOrigin=p=parseFloat(a[1]),i&&b!==Zt&&(h=b[0],c=b[1],u=b[2],x=b[3],d=b[4],o=f*(x/(y=h*x-c*u))+p*(-u/y)+(u*(g=b[5])-x*d)/y,l=f*(-c/y)+p*(h/y)-(h*g-c*d)/y,f=r.xOrigin=a[0]=o,p=r.yOrigin=a[1]=l),v&&(n&&(r.xOffset=v.xOffset,r.yOffset=v.yOffset,v=r),s||!1!==s&&!1!==I.defaultSmoothOrigin?(o=f-m,l=p-_,v.xOffset+=o*b[0]+l*b[2]-o,v.yOffset+=o*b[1]+l*b[3]-l):v.xOffset=v.yOffset=0),n||t.setAttribute("data-svg-origin",a.join(" "))},Wt=function(t){return!!(jt&&t.getBBox&&t.getCTM&&function(t){try{return t.getBBox()}catch(t){}}(t)&&(!t.parentNode||t.parentNode.getBBox&&t.parentNode.getCTM))},Zt=[1,0,0,1,0,0],Et=function(t,e){var r,i,s,n,a,o,l=t._gsTransform||new Bt,f=t.style;if(At?i=tt(t,Ct,null,!0):t.currentStyle&&(i=(i=t.currentStyle.filter.match(c))&&4===i.length?[i[0].substr(4),Number(i[2].substr(4)),Number(i[1].substr(4)),i[3].substr(4),l.x||0,l.y||0].join(","):""),(r=!i||"none"===i||"matrix(1, 0, 0, 1, 0, 0)"===i)&&At&&((o="none"===K(t).display)||!t.parentNode)&&(o&&(n=f.display,f.display="block"),t.parentNode||(a=1,Lt.appendChild(t)),r=!(i=tt(t,Ct,null,!0))||"none"===i||"matrix(1, 0, 0, 1, 0, 0)"===i,n?f.display=n:o&&Ut(f,"display"),a&&Lt.removeChild(t)),(l.svg||t.getBBox&&Wt(t))&&(r&&-1!==(f[At]+"").indexOf("matrix")&&(i=f[At],r=0),s=t.getAttribute("transform"),r&&s&&(-1!==s.indexOf("matrix")?(i=s,r=0):-1!==s.indexOf("translate")&&(i="matrix(1,0,0,1,"+s.match(/(?:\-|\b)[\d\-\.e]+\b/gi).join(",")+")",r=0))),r)return Zt;for(s=(i||"").match(R)||[],wt=s.length;-1<--wt;)n=Number(s[wt]),s[wt]=(a=n-(n|=0))?(1e5*a+(a<0?-.5:.5)|0)/1e5+n:n;return e&&6<s.length?[s[0],s[1],s[4],s[5],s[12],s[13]]:s},qt=s.getTransform=function(t,e,r,i){if(t._gsTransform&&r&&!i)return t._gsTransform;var s,n,a,o,l,f,p=r&&t._gsTransform||new Bt,h=p.scaleX<0,c=Nt&&(parseFloat(tt(t,zt,e,!1,"0 0 0").split(" ")[2])||p.zOrigin)||0,u=parseFloat(I.defaultTransformPerspective)||0;if(p.svg=!(!t.getBBox||!Wt(t)),p.svg&&(Dt(t,tt(t,zt,e,!1,"50% 50%")+"",p,t.getAttribute("data-svg-origin")),kt=I.useSVGTransformAttr||It),(s=Et(t))!==Zt){if(16===s.length){var x,d,g,y,m,_=s[0],v=s[1],b=s[2],O=s[3],w=s[4],P=s[5],T=s[6],M=s[7],k=s[8],X=s[9],S=s[10],R=s[12],F=s[13],Y=s[14],A=s[11],C=Math.atan2(T,S);p.zOrigin&&(R=k*(Y=-p.zOrigin)-s[12],F=X*Y-s[13],Y=S*Y+p.zOrigin-s[14]),p.rotationX=C*D,C&&(x=w*(y=Math.cos(-C))+k*(m=Math.sin(-C)),d=P*y+X*m,g=T*y+S*m,k=w*-m+k*y,X=P*-m+X*y,S=T*-m+S*y,A=M*-m+A*y,w=x,P=d,T=g),C=Math.atan2(-b,S),p.rotationY=C*D,C&&(d=v*(y=Math.cos(-C))-X*(m=Math.sin(-C)),g=b*y-S*m,X=v*m+X*y,S=b*m+S*y,A=O*m+A*y,_=x=_*y-k*m,v=d,b=g),C=Math.atan2(v,_),p.rotation=C*D,C&&(_=_*(y=Math.cos(-C))+w*(m=Math.sin(-C)),d=v*y+P*m,P=v*-m+P*y,T=b*-m+T*y,v=d),p.rotationX&&359.9<Math.abs(p.rotationX)+Math.abs(p.rotation)&&(p.rotationX=p.rotation=0,p.rotationY=180-p.rotationY),p.scaleX=(1e5*Math.sqrt(_*_+v*v)+.5|0)/1e5,p.scaleY=(1e5*Math.sqrt(P*P+X*X)+.5|0)/1e5,p.scaleZ=(1e5*Math.sqrt(T*T+S*S)+.5|0)/1e5,p.rotationX||p.rotationY?p.skewX=0:(p.skewX=w||P?Math.atan2(w,P)*D+p.rotation:p.skewX||0,90<Math.abs(p.skewX)&&Math.abs(p.skewX)<270&&(h?(p.scaleX*=-1,p.skewX+=p.rotation<=0?180:-180,p.rotation+=p.rotation<=0?180:-180):(p.scaleY*=-1,p.skewX+=p.skewX<=0?180:-180))),p.perspective=A?1/(A<0?-A:A):0,p.x=R,p.y=F,p.z=Y,p.svg&&(p.x-=p.xOrigin-(p.xOrigin*_-p.yOrigin*w),p.y-=p.yOrigin-(p.yOrigin*v-p.xOrigin*P))}else if(!Nt||i||!s.length||p.x!==s[4]||p.y!==s[5]||!p.rotationX&&!p.rotationY){var z=6<=s.length,N=z?s[0]:1,B=s[1]||0,j=s[2]||0,V=z?s[3]:1;p.x=s[4]||0,p.y=s[5]||0,a=Math.sqrt(N*N+B*B),o=Math.sqrt(V*V+j*j),l=N||B?Math.atan2(B,N)*D:p.rotation||0,f=j||V?Math.atan2(j,V)*D+l:p.skewX||0,90<Math.abs(f)&&Math.abs(f)<270&&(h?(a*=-1,f+=l<=0?180:-180,l+=l<=0?180:-180):(o*=-1,f+=f<=0?180:-180)),p.scaleX=a,p.scaleY=o,p.rotation=l,p.skewX=f,Nt&&(p.rotationX=p.rotationY=p.z=0,p.perspective=u,p.scaleZ=1),p.svg&&(p.x-=p.xOrigin-(p.xOrigin*N+p.yOrigin*j),p.y-=p.yOrigin-(p.xOrigin*B+p.yOrigin*V))}for(n in p.zOrigin=c,p)p[n]<2e-5&&-2e-5<p[n]&&(p[n]=0)}return r&&(t._gsTransform=p).svg&&(kt&&t.style[At]?L.delayedCall(.001,function(){Ut(t.style,At)}):!kt&&t.getAttribute("transform")&&L.delayedCall(.001,function(){t.removeAttribute("transform")})),p},$t=function(t){var e,r,i=this.data,s=-i.rotation*V,n=s+i.skewX*V,a=1e5,o=(Math.cos(s)*i.scaleX*a|0)/a,l=(Math.sin(s)*i.scaleX*a|0)/a,f=(Math.sin(n)*-i.scaleY*a|0)/a,p=(Math.cos(n)*i.scaleY*a|0)/a,h=this.t.style,c=this.t.currentStyle;if(c){r=l,l=-f,f=-r,e=c.filter,h.filter="";var u,x,d=this.t.offsetWidth,g=this.t.offsetHeight,y="absolute"!==c.position,m="progid:DXImageTransform.Microsoft.Matrix(M11="+o+", M12="+l+", M21="+f+", M22="+p,_=i.x+d*i.xPercent/100,v=i.y+g*i.yPercent/100;if(null!=i.ox&&(_+=(u=(i.oxp?d*i.ox*.01:i.ox)-d/2)-(u*o+(x=(i.oyp?g*i.oy*.01:i.oy)-g/2)*l),v+=x-(u*f+x*p)),m+=y?", Dx="+((u=d/2)-(u*o+(x=g/2)*l)+_)+", Dy="+(x-(u*f+x*p)+v)+")":", sizingMethod='auto expand')",-1!==e.indexOf("DXImageTransform.Microsoft.Matrix(")?h.filter=e.replace(C,m):h.filter=m+" "+e,0!==t&&1!==t||1===o&&0===l&&0===f&&1===p&&(y&&-1===m.indexOf("Dx=0, Dy=0")||A.test(e)&&100!==parseFloat(RegExp.$1)||-1===e.indexOf(e.indexOf("Alpha"))&&h.removeAttribute("filter")),!y){var b,O,w,P=M<8?1:-1;for(u=i.ieOffsetX||0,x=i.ieOffsetY||0,i.ieOffsetX=Math.round((d-((o<0?-o:o)*d+(l<0?-l:l)*g))/2+_),i.ieOffsetY=Math.round((g-((p<0?-p:p)*g+(f<0?-f:f)*d))/2+v),wt=0;wt<4;wt++)w=(r=-1!==(b=c[O=at[wt]]).indexOf("px")?parseFloat(b):et(this.t,O,parseFloat(b),b.replace(Y,""))||0)!==i[O]?wt<2?-i.ieOffsetX:-i.ieOffsetY:wt<2?u-i.ieOffsetX:x-i.ieOffsetY,h[O]=(i[O]=Math.round(r-w*(0===wt||2===wt?1:P)))+"px"}}},Ht=s.set3DTransformRatio=s.setTransformRatio=function(t){var e,r,i,s,n,a,o,l,f,p,h,c,u,x,d,g,y,m,_,v,b,O,w,P=this.data,T=this.t.style,M=P.rotation,k=P.rotationX,X=P.rotationY,S=P.scaleX,R=P.scaleY,F=P.scaleZ,Y=P.x,A=P.y,C=P.z,z=P.svg,N=P.perspective,B=P.force3D;if(!((1!==t&&0!==t||"auto"!==B||this.tween._totalTime!==this.tween._totalDuration&&this.tween._totalTime)&&B||C||N||X||k||1!==F)||kt&&z||!Nt)M||P.skewX||z?(M*=V,O=P.skewX*V,w=1e5,e=Math.cos(M)*S,s=Math.sin(M)*S,r=Math.sin(M-O)*-R,n=Math.cos(M-O)*R,O&&"simple"===P.skewType&&(y=Math.tan(O-P.skewY*V),r*=y=Math.sqrt(1+y*y),n*=y,P.skewY&&(y=Math.tan(P.skewY*V),e*=y=Math.sqrt(1+y*y),s*=y)),z&&(Y+=P.xOrigin-(P.xOrigin*e+P.yOrigin*r)+P.xOffset,A+=P.yOrigin-(P.xOrigin*s+P.yOrigin*n)+P.yOffset,kt&&(P.xPercent||P.yPercent)&&(x=this.t.getBBox(),Y+=.01*P.xPercent*x.width,A+=.01*P.yPercent*x.height),Y<(x=1e-6)&&-x<Y&&(Y=0),A<x&&-x<A&&(A=0)),_=(e*w|0)/w+","+(s*w|0)/w+","+(r*w|0)/w+","+(n*w|0)/w+","+Y+","+A+")",z&&kt?this.t.setAttribute("transform","matrix("+_):T[At]=(P.xPercent||P.yPercent?"translate("+P.xPercent+"%,"+P.yPercent+"%) matrix(":"matrix(")+_):T[At]=(P.xPercent||P.yPercent?"translate("+P.xPercent+"%,"+P.yPercent+"%) matrix(":"matrix(")+S+",0,0,"+R+","+Y+","+A+")";else{if(j&&(S<(x=1e-4)&&-x<S&&(S=F=2e-5),R<x&&-x<R&&(R=F=2e-5),!N||P.z||P.rotationX||P.rotationY||(N=0)),M||P.skewX)M*=V,d=e=Math.cos(M),g=s=Math.sin(M),P.skewX&&(M-=P.skewX*V,d=Math.cos(M),g=Math.sin(M),"simple"===P.skewType&&(y=Math.tan((P.skewX-P.skewY)*V),d*=y=Math.sqrt(1+y*y),g*=y,P.skewY&&(y=Math.tan(P.skewY*V),e*=y=Math.sqrt(1+y*y),s*=y))),r=-g,n=d;else{if(!(X||k||1!==F||N||z))return void(T[At]=(P.xPercent||P.yPercent?"translate("+P.xPercent+"%,"+P.yPercent+"%) translate3d(":"translate3d(")+Y+"px,"+A+"px,"+C+"px)"+(1!==S||1!==R?" scale("+S+","+R+")":""));e=n=1,r=s=0}f=1,i=a=o=l=p=h=0,c=N?-1/N:0,u=P.zOrigin,x=1e-6,v=",",b="0",(M=X*V)&&(d=Math.cos(M),p=c*(o=-(g=Math.sin(M))),i=e*g,a=s*g,c*=f=d,e*=d,s*=d),(M=k*V)&&(y=r*(d=Math.cos(M))+i*(g=Math.sin(M)),m=n*d+a*g,l=f*g,h=c*g,i=r*-g+i*d,a=n*-g+a*d,f*=d,c*=d,r=y,n=m),1!==F&&(i*=F,a*=F,f*=F,c*=F),1!==R&&(r*=R,n*=R,l*=R,h*=R),1!==S&&(e*=S,s*=S,o*=S,p*=S),(u||z)&&(u&&(Y+=i*-u,A+=a*-u,C+=f*-u+u),z&&(Y+=P.xOrigin-(P.xOrigin*e+P.yOrigin*r)+P.xOffset,A+=P.yOrigin-(P.xOrigin*s+P.yOrigin*n)+P.yOffset),Y<x&&-x<Y&&(Y=b),A<x&&-x<A&&(A=b),C<x&&-x<C&&(C=0)),_=P.xPercent||P.yPercent?"translate("+P.xPercent+"%,"+P.yPercent+"%) matrix3d(":"matrix3d(",_+=(e<x&&-x<e?b:e)+v+(s<x&&-x<s?b:s)+v+(o<x&&-x<o?b:o),_+=v+(p<x&&-x<p?b:p)+v+(r<x&&-x<r?b:r)+v+(n<x&&-x<n?b:n),k||X||1!==F?(_+=v+(l<x&&-x<l?b:l)+v+(h<x&&-x<h?b:h)+v+(i<x&&-x<i?b:i),_+=v+(a<x&&-x<a?b:a)+v+(f<x&&-x<f?b:f)+v+(c<x&&-x<c?b:c)+v):_+=",0,0,0,0,1,0,",_+=Y+v+A+v+C+v+(N?1+-C/N:1)+")",T[At]=_}};(t=Bt.prototype).x=t.y=t.z=t.skewX=t.skewY=t.rotation=t.rotationX=t.rotationY=t.zOrigin=t.xPercent=t.yPercent=t.xOffset=t.yOffset=0,t.scaleX=t.scaleY=t.scaleZ=1,Tt("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin",{parser:function(t,e,r,i,s,n,a){if(i._lastParsedTransform===a)return s;var o;"function"==typeof(i._lastParsedTransform=a)[r]&&(o=a[r],a[r]=e);var l,f,p,h,c,u,x,d,g,y=t._gsTransform,m=t.style,_=Yt.length,v=a,b={},O="transformOrigin",w=qt(t,T,!0,v.parseTransform),P=v.transform&&("function"==typeof v.transform?v.transform(S,X):v.transform);if(i._transform=w,P&&"string"==typeof P&&At)(f=Z.style)[At]=P,f.display="block",f.position="absolute",W.body.appendChild(Z),l=qt(Z,null,!1),w.svg&&(u=w.xOrigin,x=w.yOrigin,l.x-=w.xOffset,l.y-=w.yOffset,(v.transformOrigin||v.svgOrigin)&&(P={},Dt(t,lt(v.transformOrigin),P,v.svgOrigin,v.smoothOrigin,!0),u=P.xOrigin,x=P.yOrigin,l.x-=P.xOffset-w.xOffset,l.y-=P.yOffset-w.yOffset),(u||x)&&(d=Et(Z,!0),l.x-=u-(u*d[0]+x*d[2]),l.y-=x-(u*d[1]+x*d[3]))),W.body.removeChild(Z),l.perspective||(l.perspective=w.perspective),null!=v.xPercent&&(l.xPercent=pt(v.xPercent,w.xPercent)),null!=v.yPercent&&(l.yPercent=pt(v.yPercent,w.yPercent));else if("object"==typeof v){if(l={scaleX:pt(null!=v.scaleX?v.scaleX:v.scale,w.scaleX),scaleY:pt(null!=v.scaleY?v.scaleY:v.scale,w.scaleY),scaleZ:pt(v.scaleZ,w.scaleZ),x:pt(v.x,w.x),y:pt(v.y,w.y),z:pt(v.z,w.z),xPercent:pt(v.xPercent,w.xPercent),yPercent:pt(v.yPercent,w.yPercent),perspective:pt(v.transformPerspective,w.perspective)},null!=(c=v.directionalRotation))if("object"==typeof c)for(f in c)v[f]=c[f];else v.rotation=c;"string"==typeof v.x&&-1!==v.x.indexOf("%")&&(l.x=0,l.xPercent=pt(v.x,w.xPercent)),"string"==typeof v.y&&-1!==v.y.indexOf("%")&&(l.y=0,l.yPercent=pt(v.y,w.yPercent)),l.rotation=ht("rotation"in v?v.rotation:"shortRotation"in v?v.shortRotation+"_short":"rotationZ"in v?v.rotationZ:w.rotation-w.skewY,w.rotation-w.skewY,"rotation",b),Nt&&(l.rotationX=ht("rotationX"in v?v.rotationX:"shortRotationX"in v?v.shortRotationX+"_short":w.rotationX||0,w.rotationX,"rotationX",b),l.rotationY=ht("rotationY"in v?v.rotationY:"shortRotationY"in v?v.shortRotationY+"_short":w.rotationY||0,w.rotationY,"rotationY",b)),l.skewX=ht(v.skewX,w.skewX-w.skewY),(l.skewY=ht(v.skewY,w.skewY))&&(l.skewX+=l.skewY,l.rotation+=l.skewY)}for(Nt&&null!=v.force3D&&(w.force3D=v.force3D,h=!0),w.skewType=v.skewType||w.skewType||I.defaultSkewType,(p=w.force3D||w.z||w.rotationX||w.rotationY||l.z||l.rotationX||l.rotationY||l.perspective)||null==v.scale||(l.scaleZ=1);-1<--_;)(1e-6<(P=l[g=Yt[_]]-w[g])||P<-1e-6||null!=v[g]||null!=B[g])&&(h=!0,s=new vt(w,g,w[g],P,s),g in b&&(s.e=b[g]),s.xs0=0,s.plugin=n,i._overwriteProps.push(s.n));return P=v.transformOrigin,w.svg&&(P||v.svgOrigin)&&(u=w.xOffset,x=w.yOffset,Dt(t,lt(P),l,v.svgOrigin,v.smoothOrigin),s=bt(w,"xOrigin",(y?w:l).xOrigin,l.xOrigin,s,O),s=bt(w,"yOrigin",(y?w:l).yOrigin,l.yOrigin,s,O),u===w.xOffset&&x===w.yOffset||(s=bt(w,"xOffset",y?u:w.xOffset,w.xOffset,s,O),s=bt(w,"yOffset",y?x:w.yOffset,w.yOffset,s,O)),P=kt?null:"0px 0px"),(P||Nt&&p&&w.zOrigin)&&(At?(h=!0,g=zt,P=(P||tt(t,g,T,!1,"50% 50%"))+"",(s=new vt(m,g,0,0,s,-1,O)).b=m[g],s.plugin=n,Nt?(f=w.zOrigin,P=P.split(" "),w.zOrigin=(2<P.length&&(0===f||"0px"!==P[2])?parseFloat(P[2]):f)||0,s.xs0=s.e=P[0]+" "+(P[1]||"50%")+" 0px",(s=new vt(w,"zOrigin",0,0,s,-1,s.n)).b=f,s.xs0=s.e=w.zOrigin):s.xs0=s.e=P):lt(P+"",w)),h&&(i._transformType=w.svg&&kt||!p&&3!==this._transformType?2:3),o&&(a[r]=o),s},prefix:!0}),Tt("boxShadow",{defaultValue:"0px 0px 0px 0px #999",prefix:!0,color:!0,multi:!0,keyword:"inset"}),Tt("borderRadius",{defaultValue:"0px",parser:function(t,e,r,i,s,n){e=this.format(e);var a,o,l,f,p,h,c,u,x,d,g,y,m,_,v,b,O=["borderTopLeftRadius","borderTopRightRadius","borderBottomRightRadius","borderBottomLeftRadius"],w=t.style;for(x=parseFloat(t.offsetWidth),d=parseFloat(t.offsetHeight),a=e.split(" "),o=0;o<O.length;o++)this.p.indexOf("border")&&(O[o]=J(O[o])),-1!==(p=f=tt(t,O[o],T,!1,"0px")).indexOf(" ")&&(p=(f=p.split(" "))[0],f=f[1]),h=l=a[o],c=parseFloat(p),y=p.substr((c+"").length),""===(g=(m="="===h.charAt(1))?(u=parseInt(h.charAt(0)+"1",10),h=h.substr(2),u*=parseFloat(h),h.substr((u+"").length-(u<0?1:0))||""):(u=parseFloat(h),h.substr((u+"").length)))&&(g=P[r]||y),g!==y&&(_=et(t,"borderLeft",c,y),v=et(t,"borderTop",c,y),f="%"===g?(p=_/x*100+"%",v/d*100+"%"):"em"===g?(p=_/(b=et(t,"borderLeft",1,"em"))+"em",v/b+"em"):(p=_+"px",v+"px"),m&&(h=parseFloat(p)+u+g,l=parseFloat(f)+u+g)),s=Ot(w,O[o],p+" "+f,h+" "+l,!1,"0px",s);return s},prefix:!0,formatter:yt("0px 0px 0px 0px",!1,!0)}),Tt("borderBottomLeftRadius,borderBottomRightRadius,borderTopLeftRadius,borderTopRightRadius",{defaultValue:"0px",parser:function(t,e,r,i,s,n){return Ot(t.style,r,this.format(tt(t,r,T,!1,"0px 0px")),this.format(e),!1,"0px",s)},prefix:!0,formatter:yt("0px 0px",!1,!0)}),Tt("backgroundPosition",{defaultValue:"0 0",parser:function(t,e,r,i,s,n){var a,o,l,f,p,h,c="background-position",u=T||K(t,null),x=this.format((u?M?u.getPropertyValue(c+"-x")+" "+u.getPropertyValue(c+"-y"):u.getPropertyValue(c):t.currentStyle.backgroundPositionX+" "+t.currentStyle.backgroundPositionY)||"0 0"),d=this.format(e);if(-1!==x.indexOf("%")!=(-1!==d.indexOf("%"))&&d.split(",").length<2&&(h=tt(t,"backgroundImage").replace(w,""))&&"none"!==h){for(a=x.split(" "),o=d.split(" "),E.setAttribute("src",h),l=2;-1<--l;)(f=-1!==(x=a[l]).indexOf("%"))!==(-1!==o[l].indexOf("%"))&&(p=0===l?t.offsetWidth-E.width:t.offsetHeight-E.height,a[l]=f?parseFloat(x)/100*p+"px":parseFloat(x)/p*100+"%");x=a.join(" ")}return this.parseComplex(t.style,x,d,s,n)},formatter:lt}),Tt("backgroundSize",{defaultValue:"0 0",formatter:function(t){return lt(-1===(t+="").indexOf(" ")?t+" "+t:t)}}),Tt("perspective",{defaultValue:"0px",prefix:!0}),Tt("perspectiveOrigin",{defaultValue:"50% 50%",prefix:!0}),Tt("transformStyle",{prefix:!0}),Tt("backfaceVisibility",{prefix:!0}),Tt("userSelect",{prefix:!0}),Tt("margin",{parser:mt("marginTop,marginRight,marginBottom,marginLeft")}),Tt("padding",{parser:mt("paddingTop,paddingRight,paddingBottom,paddingLeft")}),Tt("clip",{defaultValue:"rect(0px,0px,0px,0px)",parser:function(t,e,r,i,s,n){var a,o,l;return e=M<9?(o=t.currentStyle,l=M<8?" ":",",a="rect("+o.clipTop+l+o.clipRight+l+o.clipBottom+l+o.clipLeft+")",this.format(e).split(",").join(l)):(a=this.format(tt(t,this.p,T,!1,this.dflt)),this.format(e)),this.parseComplex(t.style,a,e,s,n)}}),Tt("textShadow",{defaultValue:"0px 0px 0px #999",color:!0,multi:!0}),Tt("autoRound,strictUnits",{parser:function(t,e,r,i,s){return s}}),Tt("border",{defaultValue:"0px solid #000",parser:function(t,e,r,i,s,n){var a=tt(t,"borderTopWidth",T,!1,"0px"),o=this.format(e).split(" "),l=o[0].replace(Y,"");return"px"!==l&&(a=parseFloat(a)/et(t,"borderTopWidth",1,l)+l),this.parseComplex(t.style,this.format(a+" "+tt(t,"borderTopStyle",T,!1,"solid")+" "+tt(t,"borderTopColor",T,!1,"#000")),o.join(" "),s,n)},color:!0,formatter:function(t){var e=t.split(" ");return e[0]+" "+(e[1]||"solid")+" "+(t.match(gt)||["#000"])[0]}}),Tt("borderWidth",{parser:mt("borderTopWidth,borderRightWidth,borderBottomWidth,borderLeftWidth")}),Tt("float,cssFloat,styleFloat",{parser:function(t,e,r,i,s,n){var a=t.style,o="cssFloat"in a?"cssFloat":"styleFloat";return new vt(a,o,0,0,s,-1,r,!1,0,a[o],e)}});var Gt=function(t){var e,r=this.t,i=r.filter||tt(this.data,"filter")||"",s=this.s+this.c*t|0;100===s&&(e=-1===i.indexOf("atrix(")&&-1===i.indexOf("radient(")&&-1===i.indexOf("oader(")?(r.removeAttribute("filter"),!tt(this.data,"filter")):(r.filter=i.replace(a,""),!0)),e||(this.xn1&&(r.filter=i=i||"alpha(opacity="+s+")"),-1===i.indexOf("pacity")?0===s&&this.xn1||(r.filter=i+" alpha(opacity="+s+")"):r.filter=i.replace(A,"opacity="+s))};Tt("opacity,alpha,autoAlpha",{defaultValue:"1",parser:function(t,e,r,i,s,n){var a=parseFloat(tt(t,"opacity",T,!1,"1")),o=t.style,l="autoAlpha"===r;return"string"==typeof e&&"="===e.charAt(1)&&(e=("-"===e.charAt(0)?-1:1)*parseFloat(e.substr(2))+a),l&&1===a&&"hidden"===tt(t,"visibility",T)&&0!==e&&(a=0),$?s=new vt(o,"opacity",a,e-a,s):((s=new vt(o,"opacity",100*a,100*(e-a),s)).xn1=l?1:0,o.zoom=1,s.type=2,s.b="alpha(opacity="+s.s+")",s.e="alpha(opacity="+(s.s+s.c)+")",s.data=t,s.plugin=n,s.setRatio=Gt),l&&((s=new vt(o,"visibility",0,0,s,-1,null,!1,0,0!==a?"inherit":"hidden",0===e?"hidden":"inherit")).xs0="inherit",i._overwriteProps.push(s.n),i._overwriteProps.push(r)),s}});var Ut=function(t,e){e&&(t.removeProperty?("ms"!==e.substr(0,2)&&"webkit"!==e.substr(0,6)||(e="-"+e),t.removeProperty(e.replace(o,"-$1").toLowerCase())):t.removeAttribute(e))},Qt=function(t){if(this.t._gsClassPT=this,1===t||0===t){this.t.setAttribute("class",0===t?this.b:this.e);for(var e=this.data,r=this.t.style;e;)e.v?r[e.p]=e.v:Ut(r,e.p),e=e._next;1===t&&this.t._gsClassPT===this&&(this.t._gsClassPT=null)}else this.t.getAttribute("class")!==this.e&&this.t.setAttribute("class",this.e)};Tt("className",{parser:function(t,e,r,i,s,n,a){var o,l,f,p,h,c=t.getAttribute("class")||"",u=t.style.cssText;if((s=i._classNamePT=new vt(t,r,0,0,s,2)).setRatio=Qt,s.pr=-11,x=!0,s.b=c,l=it(t,T),f=t._gsClassPT){for(p={},h=f.data;h;)p[h.p]=1,h=h._next;f.setRatio(1)}return(t._gsClassPT=s).e="="!==e.charAt(1)?e:c.replace(new RegExp("(?:\\s|^)"+e.substr(2)+"(?![\\w-])"),"")+("+"===e.charAt(0)?" "+e.substr(2):""),t.setAttribute("class",s.e),o=st(t,l,it(t),a,p),t.setAttribute("class",c),s.data=o.firstMPT,t.style.cssText=u,s=s.xfirst=i.parse(t,o.difs,s,n)}});var Jt=function(t){if((1===t||0===t)&&this.data._totalTime===this.data._totalDuration&&"isFromStart"!==this.data.data){var e,r,i,s,n,a=this.t.style,o=g.transform.parse;if("all"===this.e)s=!(a.cssText="");else for(i=(e=this.e.split(" ").join("").split(",")).length;-1<--i;)r=e[i],g[r]&&(g[r].parse===o?s=!0:r="transformOrigin"===r?zt:g[r].p),Ut(a,r);s&&(Ut(a,At),(n=this.t._gsTransform)&&(n.svg&&(this.t.removeAttribute("data-svg-origin"),this.t.removeAttribute("transform")),delete this.t._gsTransform))}};for(Tt("clearProps",{parser:function(t,e,r,i,s){return(s=new vt(t,r,0,0,s,2)).setRatio=Jt,s.e=e,s.pr=-10,s.data=i._tween,x=!0,s}}),t="bezier,throwProps,physicsProps,physics2D".split(","),wt=t.length;wt--;)Mt(t[wt]);(t=I.prototype)._firstPT=t._lastParsedTransform=t._transform=null,t._onInitTween=function(t,e,r,i){if(!t.nodeType)return!1;this._target=X=t,this._tween=r,this._vars=e,S=i,k=e.autoRound,x=!1,P=e.suffixMap||I.suffixMap,T=K(t,""),d=this._overwriteProps;var s,n,a,o,l,f,p,h,c,u=t.style;if(y&&""===u.zIndex&&("auto"!==(s=tt(t,"zIndex",T))&&""!==s||this._addLazySet(u,"zIndex",0)),"string"==typeof e&&(o=u.cssText,s=it(t,T),u.cssText=o+";"+e,s=st(t,s,it(t)).difs,!$&&b.test(e)&&(s.opacity=parseFloat(RegExp.$1)),e=s,u.cssText=o),e.className?this._firstPT=n=g.className.parse(t,e.className,"className",this,null,null,e):this._firstPT=n=this.parse(t,e,null),this._transformType){for(c=3===this._transformType,At?m&&(y=!0,""===u.zIndex&&("auto"!==(p=tt(t,"zIndex",T))&&""!==p||this._addLazySet(u,"zIndex",0)),_&&this._addLazySet(u,"WebkitBackfaceVisibility",this._vars.WebkitBackfaceVisibility||(c?"visible":"hidden"))):u.zoom=1,a=n;a&&a._next;)a=a._next;h=new vt(t,"transform",0,0,null,2),this._linkCSSP(h,null,a),h.setRatio=At?Ht:$t,h.data=this._transform||qt(t,T,!0),h.tween=r,h.pr=-1,d.pop()}if(x){for(;n;){for(f=n._next,a=o;a&&a.pr>n.pr;)a=a._next;(n._prev=a?a._prev:l)?n._prev._next=n:o=n,(n._next=a)?a._prev=n:l=n,n=f}this._firstPT=o}return!0},t.parse=function(t,e,r,i){var s,n,a,o,l,f,p,h,c,u,x=t.style;for(s in e)"function"==typeof(f=e[s])&&(f=f(S,X)),(n=g[s])?r=n.parse(t,f,s,this,r,i,e):(l=tt(t,s,T)+"",c="string"==typeof f,"color"===s||"fill"===s||"stroke"===s||-1!==s.indexOf("Color")||c&&O.test(f)?(c||(f=(3<(f=xt(f)).length?"rgba(":"rgb(")+f.join(",")+")"),r=Ot(x,s,l,f,!0,"transparent",r,0,i)):c&&N.test(f)?r=Ot(x,s,l,f,!0,null,r,0,i):(p=(a=parseFloat(l))||0===a?l.substr((a+"").length):"",""!==l&&"auto"!==l||(p="width"===s||"height"===s?(a=ot(t,s,T),"px"):"left"===s||"top"===s?(a=rt(t,s,T),"px"):(a="opacity"!==s?0:1,"")),""===(h=(u=c&&"="===f.charAt(1))?(o=parseInt(f.charAt(0)+"1",10),f=f.substr(2),o*=parseFloat(f),f.replace(Y,"")):(o=parseFloat(f),c?f.replace(Y,""):""))&&(h=s in P?P[s]:p),f=o||0===o?(u?o+a:o)+h:e[s],p!==h&&""!==h&&(o||0===o)&&a&&(a=et(t,s,a,p),"%"===h?(a/=et(t,s,100,"%")/100,!0!==e.strictUnits&&(l=a+"%")):"em"===h||"rem"===h||"vw"===h||"vh"===h?a/=et(t,s,1,h):"px"!==h&&(o=et(t,s,o,h),h="px"),u&&(o||0===o)&&(f=o+a+h)),u&&(o+=a),!a&&0!==a||!o&&0!==o?void 0!==x[s]&&(f||f+""!="NaN"&&null!=f)?(r=new vt(x,s,o||a||0,0,r,-1,s,!1,0,l,f)).xs0="none"!==f||"display"!==s&&-1===s.indexOf("Style")?f:l:G("invalid "+s+" tween value: "+e[s]):(r=new vt(x,s,a,o-a,r,0,s,!1!==k&&("px"===h||"zIndex"===s),0,l,f)).xs0=h)),i&&r&&!r.plugin&&(r.plugin=i);return r},t.setRatio=function(t){var e,r,i,s=this._firstPT;if(1!==t||this._tween._time!==this._tween._duration&&0!==this._tween._time)if(t||this._tween._time!==this._tween._duration&&0!==this._tween._time||-1e-6===this._tween._rawPrevTime)for(;s;){if(e=s.c*t+s.s,s.r?e=Math.round(e):e<1e-6&&-1e-6<e&&(e=0),s.type)if(1===s.type)if(2===(i=s.l))s.t[s.p]=s.xs0+e+s.xs1+s.xn1+s.xs2;else if(3===i)s.t[s.p]=s.xs0+e+s.xs1+s.xn1+s.xs2+s.xn2+s.xs3;else if(4===i)s.t[s.p]=s.xs0+e+s.xs1+s.xn1+s.xs2+s.xn2+s.xs3+s.xn3+s.xs4;else if(5===i)s.t[s.p]=s.xs0+e+s.xs1+s.xn1+s.xs2+s.xn2+s.xs3+s.xn3+s.xs4+s.xn4+s.xs5;else{for(r=s.xs0+e+s.xs1,i=1;i<s.l;i++)r+=s["xn"+i]+s["xs"+(i+1)];s.t[s.p]=r}else-1===s.type?s.t[s.p]=s.xs0:s.setRatio&&s.setRatio(t);else s.t[s.p]=e+s.xs0;s=s._next}else for(;s;)2!==s.type?s.t[s.p]=s.b:s.setRatio(t),s=s._next;else for(;s;){if(2!==s.type)if(s.r&&-1!==s.type)if(e=Math.round(s.s+s.c),s.type){if(1===s.type){for(i=s.l,r=s.xs0+e+s.xs1,i=1;i<s.l;i++)r+=s["xn"+i]+s["xs"+(i+1)];s.t[s.p]=r}}else s.t[s.p]=e+s.xs0;else s.t[s.p]=s.e;else s.setRatio(t);s=s._next}},t._enableTransforms=function(t){this._transform=this._transform||qt(this._target,T,!0),this._transformType=this._transform.svg&&kt||!t&&3!==this._transformType?2:3};var Kt=function(t){this.t[this.p]=this.e,this.data._linkCSSP(this,this._next,null,!0)};t._addLazySet=function(t,e,r){var i=this._firstPT=new vt(t,e,0,0,this._firstPT,2);i.e=r,i.setRatio=Kt,i.data=this},t._linkCSSP=function(t,e,r,i){return t&&(e&&(e._prev=t),t._next&&(t._next._prev=t._prev),t._prev?t._prev._next=t._next:this._firstPT===t&&(this._firstPT=t._next,i=!0),r?r._next=t:i||null!==this._firstPT||(this._firstPT=t),t._next=e,t._prev=r),t},t._mod=function(t){for(var e=this._firstPT;e;)"function"==typeof t[e.p]&&t[e.p]===Math.round&&(e.r=1),e=e._next},t._kill=function(t){var e,r,i,s=t;if(t.autoAlpha||t.alpha){for(r in s={},t)s[r]=t[r];s.opacity=1,s.autoAlpha&&(s.visibility=1)}for(t.className&&(e=this._classNamePT)&&((i=e.xfirst)&&i._prev?this._linkCSSP(i._prev,e._next,i._prev._prev):i===this._firstPT&&(this._firstPT=e._next),e._next&&this._linkCSSP(e._next,e._next._next,i._prev),this._classNamePT=null),e=this._firstPT;e;)e.plugin&&e.plugin!==r&&e.plugin._kill&&(e.plugin._kill(t),r=e.plugin),e=e._next;return n.prototype._kill.call(this,s)};var te=function(t,e,r){var i,s,n,a;if(t.slice)for(s=t.length;-1<--s;)te(t[s],e,r);else for(s=(i=t.childNodes).length;-1<--s;)a=(n=i[s]).type,n.style&&(e.push(it(n)),r&&r.push(n)),1!==a&&9!==a&&11!==a||!n.childNodes.length||te(n,e,r)};return I.cascadeTo=function(t,e,r){var i,s,n,a,o=L.to(t,e,r),l=[o],f=[],p=[],h=[],c=L._internals.reservedProps;for(t=o._targets||o.target,te(t,f,h),o.render(e,!0,!0),te(t,p),o.render(0,!0,!0),o._enabled(!0),i=h.length;-1<--i;)if((s=st(h[i],f[i],p[i])).firstMPT){for(n in s=s.difs,r)c[n]&&(s[n]=r[n]);for(n in a={},s)a[n]=f[i][n];l.push(L.fromTo(h[i],e,a,s))}return l},n.activate([I]),I},!0)}),_gsScope._gsDefine&&_gsScope._gsQueue.pop()(),function(t){"use strict";var e=function(){return(_gsScope.GreenSockGlobals||_gsScope).CSSPlugin};"function"==typeof define&&define.amd?define(["TweenLite"],e):"undefined"!=typeof module&&module.exports&&(require("../TweenLite.js"),module.exports=e())}();
var _gsScope="undefined"!=typeof module&&module.exports&&"undefined"!=typeof global?global:this||window;(_gsScope._gsQueue||(_gsScope._gsQueue=[])).push(function(){"use strict";var h=document.documentElement,r=window,l=function(t,e){var s="x"===e?"Width":"Height",i="scroll"+s,o="client"+s,n=document.body;return t===r||t===h||t===n?Math.max(h[i],n[i])-(r["inner"+s]||h[o]||n[o]):t[i]-t["offset"+s]},u=function(t,e){var s="scroll"+("x"===e?"Left":"Top");return t===r&&(null!=t.pageXOffset?s="page"+e.toUpperCase()+"Offset":t=null!=h[s]?h:document.body),function(){return t[s]}},o=function(t,e){var s,i=(s=t,"string"==typeof s&&(s=TweenLite.selector(s)),s.length&&s!==r&&s[0]&&s[0].style&&!s.nodeType&&(s=s[0]),s===r||s.nodeType&&s.style?s:null).getBoundingClientRect(),o=!e||e===r||e===document.body,n=(o?h:e).getBoundingClientRect(),l={x:i.left-n.left,y:i.top-n.top};return!o&&e&&(l.x+=u(e,"x")(),l.y+=u(e,"y")()),l},i=function(t,e,s){var i=typeof t;return"number"===i||"string"===i&&"="===t.charAt(1)?t:"max"===t?l(e,s):Math.min(l(e,s),o(t,e)[s])},p=_gsScope._gsDefine.plugin({propName:"scrollTo",API:2,version:"1.8.0",init:function(t,e,s){return this._wdw=t===r,this._target=t,this._tween=s,"object"!=typeof e?"string"==typeof(e={y:e}).y&&"max"!==e.y&&"="!==e.y.charAt(1)&&(e.x=e.y):e.nodeType&&(e={y:e,x:e}),this.vars=e,this._autoKill=!1!==e.autoKill,this.getX=u(t,"x"),this.getY=u(t,"y"),this.x=this.xPrev=this.getX(),this.y=this.yPrev=this.getY(),null!=e.x?(this._addTween(this,"x",this.x,i(e.x,t,"x")-(e.offsetX||0),"scrollTo_x",!0),this._overwriteProps.push("scrollTo_x")):this.skipX=!0,null!=e.y?(this._addTween(this,"y",this.y,i(e.y,t,"y")-(e.offsetY||0),"scrollTo_y",!0),this._overwriteProps.push("scrollTo_y")):this.skipY=!0,!0},set:function(t){this._super.setRatio.call(this,t);var e=this._wdw||!this.skipX?this.getX():this.xPrev,s=this._wdw||!this.skipY?this.getY():this.yPrev,i=s-this.yPrev,o=e-this.xPrev,n=p.autoKillThreshold;this.x<0&&(this.x=0),this.y<0&&(this.y=0),this._autoKill&&(!this.skipX&&(n<o||o<-n)&&e<l(this._target,"x")&&(this.skipX=!0),!this.skipY&&(n<i||i<-n)&&s<l(this._target,"y")&&(this.skipY=!0),this.skipX&&this.skipY&&(this._tween.kill(),this.vars.onAutoKill&&this.vars.onAutoKill.apply(this.vars.onAutoKillScope||this._tween,this.vars.onAutoKillParams||[]))),this._wdw?r.scrollTo(this.skipX?e:this.x,this.skipY?s:this.y):(this.skipY||(this._target.scrollTop=this.y),this.skipX||(this._target.scrollLeft=this.x)),this.xPrev=this.x,this.yPrev=this.y}}),t=p.prototype;p.max=l,p.getOffset=o,p.autoKillThreshold=7,t._kill=function(t){return t.scrollTo_x&&(this.skipX=!0),t.scrollTo_y&&(this.skipY=!0),this._super._kill.call(this,t)}}),_gsScope._gsDefine&&_gsScope._gsQueue.pop()(),function(t){"use strict";var e=function(){return(_gsScope.GreenSockGlobals||_gsScope).ScrollToPlugin};"function"==typeof define&&define.amd?define(["TweenLite"],e):"undefined"!=typeof module&&module.exports&&(require("../TweenLite.js"),module.exports=e())}();
...
!function(t,e){"object"==typeof exports&&"undefined"!=typeof module?e(exports):"function"==typeof define&&define.amd?define(["exports"],e):e((t=t||self).adminlte={})}(this,function(t){"use strict";var o,e,i,n,a,r,l,c,d,h,f,s,u,g,p,_,m,v,y,C,b,w,x,I,A,E,D,S,j,Q,R,T,H,L,z,O,k,M,P,q,F,N,B,X,Z,U,V,W,Y,K,G,J,$,tt,et,it,nt,st,ot,at,rt,lt,ct,dt,ht,ft,ut,gt,pt,_t,mt,vt,yt,Ct,bt,wt,xt,It,At,Et,Dt,St,jt,Qt,Rt,Tt,Ht,Lt,zt,Ot,kt,Mt,Pt,qt,Ft,Nt,Bt,Xt,Zt,Ut,Vt,Wt,Yt,Kt,Gt,Jt,$t,te,ee,ie=(zt=jQuery,Ot="ControlSidebar",kt="lte.controlsidebar",Mt=zt.fn[Ot],Pt="collapsed.lte.controlsidebar",qt="expanded.lte.controlsidebar",Ft=".control-sidebar",Nt=".control-sidebar-content",Bt=".main-header",Xt=".main-footer",Zt="control-sidebar-animate",Ut="control-sidebar-open",Vt="control-sidebar-slide-open",Wt="layout-fixed",Yt="layout-footer-fixed",Kt="layout-sm-footer-fixed",Gt="layout-md-footer-fixed",Jt="layout-lg-footer-fixed",$t="layout-xl-footer-fixed",te={controlsidebarSlide:!0,scrollbarTheme:"os-theme-light",scrollbarAutoHide:"l"},ee=function(){function n(t,e){this._element=t,this._config=e,this._init()}var t=n.prototype;return t.collapse=function(){this._config.controlsidebarSlide?(zt("html").addClass(Zt),zt("body").removeClass(Vt).delay(300).queue(function(){zt(Ft).hide(),zt("html").removeClass(Zt),zt(this).dequeue()})):zt("body").removeClass(Ut);var t=zt.Event(Pt);zt(this._element).trigger(t)},t.show=function(){this._config.controlsidebarSlide?(zt("html").addClass(Zt),zt(Ft).show().delay(10).queue(function(){zt("body").addClass(Vt).delay(300).queue(function(){zt("html").removeClass(Zt),zt(this).dequeue()}),zt(this).dequeue()})):zt("body").addClass(Ut);var t=zt.Event(qt);zt(this._element).trigger(t)},t.toggle=function(){zt("body").hasClass(Ut)||zt("body").hasClass(Vt)?this.collapse():this.show()},t._init=function(){var t=this;this._fixHeight(),this._fixScrollHeight(),zt(window).resize(function(){t._fixHeight(),t._fixScrollHeight()}),zt(window).scroll(function(){(zt("body").hasClass(Ut)||zt("body").hasClass(Vt))&&t._fixScrollHeight()})},t._fixScrollHeight=function(){var t={scroll:zt(document).height(),window:zt(window).height(),header:zt(Bt).outerHeight(),footer:zt(Xt).outerHeight()},e=Math.abs(t.window+zt(window).scrollTop()-t.scroll),i=zt(window).scrollTop(),n=!1,s=!1;zt("body").hasClass(Wt)&&((zt("body").hasClass("layout-navbar-fixed")||zt("body").hasClass("layout-sm-navbar-fixed")||zt("body").hasClass("layout-md-navbar-fixed")||zt("body").hasClass("layout-lg-navbar-fixed")||zt("body").hasClass("layout-xl-navbar-fixed"))&&"fixed"===zt(Bt).css("position")&&(n=!0),(zt("body").hasClass(Yt)||zt("body").hasClass(Kt)||zt("body").hasClass(Gt)||zt("body").hasClass(Jt)||zt("body").hasClass($t))&&"fixed"===zt(Xt).css("position")&&(s=!0),0===i&&0===e?(zt(Ft).css("bottom",t.footer),zt(Ft).css("top",t.header),zt(Ft+", "+Ft+" "+Nt).css("height",t.window-(t.header+t.footer))):e<=t.footer?!1===s?(zt(Ft).css("bottom",t.footer-e),zt(Ft+", "+Ft+" "+Nt).css("height",t.window-(t.footer-e))):zt(Ft).css("bottom",t.footer):i<=t.header?!1===n?(zt(Ft).css("top",t.header-i),zt(Ft+", "+Ft+" "+Nt).css("height",t.window-(t.header-i))):zt(Ft).css("top",t.header):!1===n?(zt(Ft).css("top",0),zt(Ft+", "+Ft+" "+Nt).css("height",t.window)):zt(Ft).css("top",t.header))},t._fixHeight=function(){var t=zt(window).height(),e=zt(Bt).outerHeight(),i=zt(Xt).outerHeight();if(zt("body").hasClass(Wt)){var n=t-e;(zt("body").hasClass(Yt)||zt("body").hasClass(Kt)||zt("body").hasClass(Gt)||zt("body").hasClass(Jt)||zt("body").hasClass($t))&&"fixed"===zt(Xt).css("position")&&(n=t-e-i),zt(Ft+" "+Nt).css("height",n),void 0!==zt.fn.overlayScrollbars&&zt(Ft+" "+Nt).overlayScrollbars({className:this._config.scrollbarTheme,sizeAutoCapable:!0,scrollbars:{autoHide:this._config.scrollbarAutoHide,clickScrolling:!0}})}},n._jQueryInterface=function(i){return this.each(function(){var t=zt(this).data(kt),e=zt.extend({},te,zt(this).data());if(t||(t=new n(this,e),zt(this).data(kt,t)),"undefined"===t[i])throw new Error(i+" is not a function");t[i]()})},n}(),zt(document).on("click",'[data-widget="control-sidebar"]',function(t){t.preventDefault(),ee._jQueryInterface.call(zt(this),"toggle")}),zt.fn[Ot]=ee._jQueryInterface,zt.fn[Ot].Constructor=ee,zt.fn[Ot].noConflict=function(){return zt.fn[Ot]=Mt,ee._jQueryInterface},ee),ne=(wt=jQuery,xt="Layout",It=wt.fn[xt],At=".main-header",Et=".main-sidebar",Dt=".main-sidebar .sidebar",St=".content-wrapper",jt=".main-footer",Qt=".login-box",Rt=".register-box",Tt="sidebar-focused",Ht={scrollbarTheme:"os-theme-light",scrollbarAutoHide:"l",panelAutoHeight:!0,loginRegisterAutoHeight:!0},Lt=function(){function n(t,e){this._config=e,this._element=t,this._init()}var t=n.prototype;return t.fixLayoutHeight=function(t){void 0===t&&(t=null);var e=0;(wt("body").hasClass("control-sidebar-slide-open")||wt("body").hasClass("control-sidebar-open")||"control_sidebar"==t)&&(e=wt(".control-sidebar-content").height());var i={window:wt(window).height(),header:0!==wt(At).length?wt(At).outerHeight():0,footer:0!==wt(jt).length?wt(jt).outerHeight():0,sidebar:0!==wt(Dt).length?wt(Dt).height():0,control_sidebar:e},n=this._max(i),s=this._config.panelAutoHeight;!0===s&&(s=0),!1!==s&&(n==i.control_sidebar?wt(St).css("min-height",n+s):n==i.window?wt(St).css("min-height",n+s-i.header-i.footer):wt(St).css("min-height",n+s-i.header),this._isFooterFixed()&&wt(St).css("min-height",parseFloat(wt(St).css("min-height"))+i.footer)),wt("body").hasClass("layout-fixed")&&(!1!==s&&wt(St).css("min-height",n+s-i.header-i.footer),void 0!==wt.fn.overlayScrollbars&&wt(Dt).overlayScrollbars({className:this._config.scrollbarTheme,sizeAutoCapable:!0,scrollbars:{autoHide:this._config.scrollbarAutoHide,clickScrolling:!0}}))},t.fixLoginRegisterHeight=function(){if(0===wt(Qt+", "+Rt).length)wt("body, html").css("height","auto");else if(0!==wt(Qt+", "+Rt).length){var t=wt(Qt+", "+Rt).height();wt("body").css("min-height")!==t&&wt("body").css("min-height",t)}},t._init=function(){var t=this;this.fixLayoutHeight(),!0===this._config.loginRegisterAutoHeight?this.fixLoginRegisterHeight():Number.isInteger(this._config.loginRegisterAutoHeight)&&setInterval(this.fixLoginRegisterHeight,this._config.loginRegisterAutoHeight),wt(Dt).on("collapsed.lte.treeview expanded.lte.treeview",function(){t.fixLayoutHeight()}),wt('[data-widget="pushmenu"]').on("collapsed.lte.pushmenu shown.lte.pushmenu",function(){t.fixLayoutHeight()}),wt('[data-widget="control-sidebar"]').on("collapsed.lte.controlsidebar",function(){t.fixLayoutHeight()}).on("expanded.lte.controlsidebar",function(){t.fixLayoutHeight("control_sidebar")}),wt(window).resize(function(){t.fixLayoutHeight()}),setTimeout(function(){wt("body.hold-transition").removeClass("hold-transition")},50)},t._max=function(e){var i=0;return Object.keys(e).forEach(function(t){e[t]>i&&(i=e[t])}),i},t._isFooterFixed=function(){return"fixed"===wt(".main-footer").css("position")},n._jQueryInterface=function(i){return void 0===i&&(i=""),this.each(function(){var t=wt(this).data("lte.layout"),e=wt.extend({},Ht,wt(this).data());t||(t=new n(wt(this),e),wt(this).data("lte.layout",t)),"init"===i||""===i?t._init():"fixLayoutHeight"!==i&&"fixLoginRegisterHeight"!==i||t[i]()})},n}(),wt(window).on("load",function(){Lt._jQueryInterface.call(wt("body"))}),wt(Dt+" a").on("focusin",function(){wt(Et).addClass(Tt)}),wt(Dt+" a").on("focusout",function(){wt(Et).removeClass(Tt)}),wt.fn[xt]=Lt._jQueryInterface,wt.fn[xt].Constructor=Lt,wt.fn[xt].noConflict=function(){return wt.fn[xt]=It,Lt._jQueryInterface},Lt),se=(dt=jQuery,ht="PushMenu",ft=".lte.pushmenu",ut=dt.fn[ht],pt={autoCollapseSize:992,enableRemember:!(gt={COLLAPSED:"collapsed"+ft,SHOWN:"shown"+ft}),noTransitionAfterReload:!0},_t='[data-widget="pushmenu"]',mt="body",vt="sidebar-collapse",yt="sidebar-open",Ct="sidebar-closed",bt=function(){function n(t,e){this._element=t,this._options=dt.extend({},pt,e),dt("#sidebar-overlay").length||this._addOverlay(),this._init()}var t=n.prototype;return t.expand=function(){this._options.autoCollapseSize&&dt(window).width()<=this._options.autoCollapseSize&&dt(mt).addClass(yt),dt(mt).removeClass(vt).removeClass(Ct),this._options.enableRemember&&localStorage.setItem("remember"+ft,yt);var t=dt.Event(gt.SHOWN);dt(this._element).trigger(t)},t.collapse=function(){this._options.autoCollapseSize&&dt(window).width()<=this._options.autoCollapseSize&&dt(mt).removeClass(yt).addClass(Ct),dt(mt).addClass(vt),this._options.enableRemember&&localStorage.setItem("remember"+ft,vt);var t=dt.Event(gt.COLLAPSED);dt(this._element).trigger(t)},t.toggle=function(){dt(mt).hasClass(vt)?this.expand():this.collapse()},t.autoCollapse=function(t){void 0===t&&(t=!1),this._options.autoCollapseSize&&(dt(window).width()<=this._options.autoCollapseSize?dt(mt).hasClass(yt)||this.collapse():1==t&&(dt(mt).hasClass(yt)?dt(mt).removeClass(yt):dt(mt).hasClass(Ct)&&this.expand()))},t.remember=function(){this._options.enableRemember&&(localStorage.getItem("remember"+ft)==vt?this._options.noTransitionAfterReload?dt("body").addClass("hold-transition").addClass(vt).delay(50).queue(function(){dt(this).removeClass("hold-transition"),dt(this).dequeue()}):dt("body").addClass(vt):this._options.noTransitionAfterReload?dt("body").addClass("hold-transition").removeClass(vt).delay(50).queue(function(){dt(this).removeClass("hold-transition"),dt(this).dequeue()}):dt("body").removeClass(vt))},t._init=function(){var t=this;this.remember(),this.autoCollapse(),dt(window).resize(function(){t.autoCollapse(!0)})},t._addOverlay=function(){var t=this,e=dt("<div />",{id:"sidebar-overlay"});e.on("click",function(){t.collapse()}),dt(".wrapper").append(e)},n._jQueryInterface=function(i){return this.each(function(){var t=dt(this).data("lte.pushmenu"),e=dt.extend({},pt,dt(this).data());t||(t=new n(this,e),dt(this).data("lte.pushmenu",t)),"string"==typeof i&&i.match(/collapse|expand|toggle/)&&t[i]()})},n}(),dt(document).on("click",_t,function(t){t.preventDefault();var e=t.currentTarget;"pushmenu"!==dt(e).data("widget")&&(e=dt(e).closest(_t)),bt._jQueryInterface.call(dt(e),"toggle")}),dt(window).on("load",function(){bt._jQueryInterface.call(dt(_t))}),dt.fn[ht]=bt._jQueryInterface,dt.fn[ht].Constructor=bt,dt.fn[ht].noConflict=function(){return dt.fn[ht]=ut,bt._jQueryInterface},bt),oe=(G=jQuery,J="Treeview",$=G.fn[J],tt="expanded.lte.treeview",et="collapsed.lte.treeview",it="load.lte.treeview",nt=".nav-item",st=".nav-treeview",ot=".menu-open",lt={trigger:(at='[data-widget="treeview"]')+" .nav-link",animationSpeed:300,accordion:!0,expandSidebar:!(rt="menu-open"),sidebarButtonSelector:'[data-widget="pushmenu"]'},ct=function(){function n(t,e){this._config=e,this._element=t}var t=n.prototype;return t.init=function(){this._setupListeners()},t.expand=function(t,e){var i=this,n=G.Event(tt);if(this._config.accordion){var s=e.siblings(ot).first(),o=s.find(st).first();this.collapse(o,s)}t.stop().slideDown(this._config.animationSpeed,function(){e.addClass(rt),G(i._element).trigger(n)}),this._config.expandSidebar&&this._expandSidebar()},t.collapse=function(t,e){var i=this,n=G.Event(et);t.stop().slideUp(this._config.animationSpeed,function(){e.removeClass(rt),G(i._element).trigger(n),t.find(ot+" > "+st).slideUp(),t.find(ot).removeClass(rt)})},t.toggle=function(t){var e=G(t.currentTarget),i=e.parent(),n=i.find("> "+st);if(n.is(st)||(i.is(nt)||(n=i.parent().find("> "+st)),n.is(st))){t.preventDefault();var s=e.parents(nt).first();s.hasClass(rt)?this.collapse(G(n),s):this.expand(G(n),s)}},t._setupListeners=function(){var e=this;G(document).on("click",this._config.trigger,function(t){e.toggle(t)})},t._expandSidebar=function(){G("body").hasClass("sidebar-collapse")&&G(this._config.sidebarButtonSelector).PushMenu("expand")},n._jQueryInterface=function(i){return this.each(function(){var t=G(this).data("lte.treeview"),e=G.extend({},lt,G(this).data());t||(t=new n(G(this),e),G(this).data("lte.treeview",t)),"init"===i&&t[i]()})},n}(),G(window).on(it,function(){G(at).each(function(){ct._jQueryInterface.call(G(this),"init")})}),G.fn[J]=ct._jQueryInterface,G.fn[J].Constructor=ct,G.fn[J].noConflict=function(){return G.fn[J]=$,ct._jQueryInterface},ct),ae=(V=jQuery,W="DirectChat",Y=V.fn[W],K=function(){function i(t,e){this._element=t}return i.prototype.toggle=function(){V(this._element).parents(".direct-chat").first().toggleClass("direct-chat-contacts-open");var t=V.Event("toggled{EVENT_KEY}");V(this._element).trigger(t)},i._jQueryInterface=function(e){return this.each(function(){var t=V(this).data("lte.directchat");t||(t=new i(V(this)),V(this).data("lte.directchat",t)),t[e]()})},i}(),V(document).on("click",'[data-widget="chat-pane-toggle"]',function(t){t&&t.preventDefault(),K._jQueryInterface.call(V(this),"toggle")}),V.fn[W]=K._jQueryInterface,V.fn[W].Constructor=K,V.fn[W].noConflict=function(){return V.fn[W]=Y,K._jQueryInterface},K),re=(F=jQuery,N="TodoList",B=F.fn[N],X='[data-widget="todo-list"]',Z={onCheck:function(t){return t},onUnCheck:function(t){return t}},U=function(){function n(t,e){this._config=e,this._element=t,this._init()}var t=n.prototype;return t.toggle=function(t){t.parents("li").toggleClass("done"),F(t).prop("checked")?this.check(t):this.unCheck(F(t))},t.check=function(t){this._config.onCheck.call(t)},t.unCheck=function(t){this._config.onUnCheck.call(t)},t._init=function(){var e=this;F(X).find("input:checkbox:checked").parents("li").toggleClass("done"),F(X).on("change","input:checkbox",function(t){e.toggle(F(t.target))})},n._jQueryInterface=function(i){return this.each(function(){var t=F(this).data("lte.todolist"),e=F.extend({},Z,F(this).data());t||(t=new n(F(this),e),F(this).data("lte.todolist",t)),"init"===i&&t[i]()})},n}(),F(window).on("load",function(){U._jQueryInterface.call(F(X))}),F.fn[N]=U._jQueryInterface,F.fn[N].Constructor=U,F.fn[N].noConflict=function(){return F.fn[N]=B,U._jQueryInterface},U),le=(S=jQuery,j="CardWidget",Q=".lte.cardwidget",R=S.fn[j],T={EXPANDED:"expanded"+Q,COLLAPSED:"collapsed"+Q,MAXIMIZED:"maximized"+Q,MINIMIZED:"minimized"+Q,REMOVED:"removed"+Q},L="collapsing-card",z="expanding-card",O="was-collapsed",k="maximized-card",P={animationSpeed:"normal",collapseTrigger:(M={DATA_REMOVE:'[data-card-widget="remove"]',DATA_COLLAPSE:'[data-card-widget="collapse"]',DATA_MAXIMIZE:'[data-card-widget="maximize"]',CARD:".card",CARD_HEADER:".card-header",CARD_BODY:".card-body",CARD_FOOTER:".card-footer",COLLAPSED:"."+(H="collapsed-card")}).DATA_COLLAPSE,removeTrigger:M.DATA_REMOVE,maximizeTrigger:M.DATA_MAXIMIZE,collapseIcon:"fa-minus",expandIcon:"fa-plus",maximizeIcon:"fa-expand",minimizeIcon:"fa-compress"},q=function(){function n(t,e){this._element=t,this._parent=t.parents(M.CARD).first(),t.hasClass("card")&&(this._parent=t),this._settings=S.extend({},P,e)}var t=n.prototype;return t.collapse=function(){var t=this;this._parent.addClass(L).children(M.CARD_BODY+", "+M.CARD_FOOTER).slideUp(this._settings.animationSpeed,function(){t._parent.addClass(H).removeClass(L)}),this._parent.find("> "+M.CARD_HEADER+" "+this._settings.collapseTrigger+" ."+this._settings.collapseIcon).addClass(this._settings.expandIcon).removeClass(this._settings.collapseIcon);var e=S.Event(T.COLLAPSED);this._element.trigger(e,this._parent)},t.expand=function(){var t=this;this._parent.addClass(z).children(M.CARD_BODY+", "+M.CARD_FOOTER).slideDown(this._settings.animationSpeed,function(){t._parent.removeClass(H).removeClass(z)}),this._parent.find("> "+M.CARD_HEADER+" "+this._settings.collapseTrigger+" ."+this._settings.expandIcon).addClass(this._settings.collapseIcon).removeClass(this._settings.expandIcon);var e=S.Event(T.EXPANDED);this._element.trigger(e,this._parent)},t.remove=function(){this._parent.slideUp();var t=S.Event(T.REMOVED);this._element.trigger(t,this._parent)},t.toggle=function(){this._parent.hasClass(H)?this.expand():this.collapse()},t.maximize=function(){this._parent.find(this._settings.maximizeTrigger+" ."+this._settings.maximizeIcon).addClass(this._settings.minimizeIcon).removeClass(this._settings.maximizeIcon),this._parent.css({height:this._parent.height(),width:this._parent.width(),transition:"all .15s"}).delay(150).queue(function(){S(this).addClass(k),S("html").addClass(k),S(this).hasClass(H)&&S(this).addClass(O),S(this).dequeue()});var t=S.Event(T.MAXIMIZED);this._element.trigger(t,this._parent)},t.minimize=function(){this._parent.find(this._settings.maximizeTrigger+" ."+this._settings.minimizeIcon).addClass(this._settings.maximizeIcon).removeClass(this._settings.minimizeIcon),this._parent.css("cssText","height:"+this._parent[0].style.height+" !important;width:"+this._parent[0].style.width+" !important; transition: all .15s;").delay(10).queue(function(){S(this).removeClass(k),S("html").removeClass(k),S(this).css({height:"inherit",width:"inherit"}),S(this).hasClass(O)&&S(this).removeClass(O),S(this).dequeue()});var t=S.Event(T.MINIMIZED);this._element.trigger(t,this._parent)},t.toggleMaximize=function(){this._parent.hasClass(k)?this.minimize():this.maximize()},t._init=function(t){var e=this;this._parent=t,S(this).find(this._settings.collapseTrigger).click(function(){e.toggle()}),S(this).find(this._settings.maximizeTrigger).click(function(){e.toggleMaximize()}),S(this).find(this._settings.removeTrigger).click(function(){e.remove()})},n._jQueryInterface=function(t){var e=S(this).data("lte.cardwidget"),i=S.extend({},P,S(this).data());e||(e=new n(S(this),i),S(this).data("lte.cardwidget","string"==typeof t?e:t)),"string"==typeof t&&t.match(/collapse|expand|remove|toggle|maximize|minimize|toggleMaximize/)?e[t]():"object"==typeof t&&e._init(S(this))},n}(),S(document).on("click",M.DATA_COLLAPSE,function(t){t&&t.preventDefault(),q._jQueryInterface.call(S(this),"toggle")}),S(document).on("click",M.DATA_REMOVE,function(t){t&&t.preventDefault(),q._jQueryInterface.call(S(this),"remove")}),S(document).on("click",M.DATA_MAXIMIZE,function(t){t&&t.preventDefault(),q._jQueryInterface.call(S(this),"toggleMaximize")}),S.fn[j]=q._jQueryInterface,S.fn[j].Constructor=q,S.fn[j].noConflict=function(){return S.fn[j]=R,q._jQueryInterface},q),ce=(y=jQuery,C="CardRefresh",b=y.fn[C],w="loaded.lte.cardrefresh",x="overlay.added.lte.cardrefresh",I="overlay.removed.lte.cardrefresh",E={source:"",sourceSelector:"",params:{},trigger:(A={CARD:".card",DATA_REFRESH:'[data-card-widget="card-refresh"]'}).DATA_REFRESH,content:".card-body",loadInContent:!0,loadOnInit:!0,responseType:"",overlayTemplate:'<div class="overlay"><i class="fas fa-2x fa-sync-alt fa-spin"></i></div>',onLoadStart:function(){},onLoadDone:function(t){return t}},D=function(){function n(t,e){if(this._element=t,this._parent=t.parents(A.CARD).first(),this._settings=y.extend({},E,e),this._overlay=y(this._settings.overlayTemplate),t.hasClass("card")&&(this._parent=t),""===this._settings.source)throw new Error("Source url was not defined. Please specify a url in your CardRefresh source option.")}var t=n.prototype;return t.load=function(){this._addOverlay(),this._settings.onLoadStart.call(y(this)),y.get(this._settings.source,this._settings.params,function(t){this._settings.loadInContent&&(""!=this._settings.sourceSelector&&(t=y(t).find(this._settings.sourceSelector).html()),this._parent.find(this._settings.content).html(t)),this._settings.onLoadDone.call(y(this),t),this._removeOverlay()}.bind(this),""!==this._settings.responseType&&this._settings.responseType);var t=y.Event(w);y(this._element).trigger(t)},t._addOverlay=function(){this._parent.append(this._overlay);var t=y.Event(x);y(this._element).trigger(t)},t._removeOverlay=function(){this._parent.find(this._overlay).remove();var t=y.Event(I);y(this._element).trigger(t)},t._init=function(t){var e=this;y(this).find(this._settings.trigger).on("click",function(){e.load()}),this._settings.loadOnInit&&this.load()},n._jQueryInterface=function(t){var e=y(this).data("lte.cardrefresh"),i=y.extend({},E,y(this).data());e||(e=new n(y(this),i),y(this).data("lte.cardrefresh","string"==typeof t?e:t)),"string"==typeof t&&t.match(/load/)?e[t]():e._init(y(this))},n}(),y(document).on("click",A.DATA_REFRESH,function(t){t&&t.preventDefault(),D._jQueryInterface.call(y(this),"load")}),y(document).ready(function(){y(A.DATA_REFRESH).each(function(){D._jQueryInterface.call(y(this))})}),y.fn[C]=D._jQueryInterface,y.fn[C].Constructor=D,y.fn[C].noConflict=function(){return y.fn[C]=b,D._jQueryInterface},D),de=(u=jQuery,g="Dropdown",p=u.fn[g],_='[data-toggle="dropdown"]',m={},v=function(){function n(t,e){this._config=e,this._element=t}var t=n.prototype;return t.toggleSubmenu=function(){this._element.siblings().show().toggleClass("show"),this._element.next().hasClass("show")||this._element.parents(".dropdown-menu").first().find(".show").removeClass("show").hide(),this._element.parents("li.nav-item.dropdown.show").on("hidden.bs.dropdown",function(t){u(".dropdown-submenu .show").removeClass("show").hide()})},t.fixPosition=function(){var t=u(".dropdown-menu.show");if(0!==t.length){t.hasClass("dropdown-menu-right")?(t.css("left","inherit"),t.css("right",0)):(t.css("left",0),t.css("right","inherit"));var e=t.offset(),i=t.width(),n=u(window).width()-e.left;e.left<0?(t.css("left","inherit"),t.css("right",e.left-5)):n<i&&(t.css("left","inherit"),t.css("right",0))}},n._jQueryInterface=function(i){return this.each(function(){var t=u(this).data("lte.dropdown"),e=u.extend({},m,u(this).data());t||(t=new n(u(this),e),u(this).data("lte.dropdown",t)),"toggleSubmenu"!==i&&"fixPosition"!=i||t[i]()})},n}(),u(".dropdown-menu "+_).on("click",function(t){t.preventDefault(),t.stopPropagation(),v._jQueryInterface.call(u(this),"toggleSubmenu")}),u(".navbar "+_).on("click",function(t){t.preventDefault(),setTimeout(function(){v._jQueryInterface.call(u(this),"fixPosition")},1)}),u.fn[g]=v._jQueryInterface,u.fn[g].Constructor=v,u.fn[g].noConflict=function(){return u.fn[g]=p,v._jQueryInterface},v),he=(o=jQuery,e="Toasts",i=o.fn[e],n="init.lte.toasts",a="created.lte.toasts",r="removed.lte.toasts",c="topLeft",d="bottomRight",f={position:l="topRight",fixed:!0,autohide:!(h="bottomLeft"),autoremove:!0,delay:1e3,fade:!0,icon:null,image:null,imageAlt:null,imageHeight:"25px",title:null,subtitle:null,close:!0,body:null,class:null},s=function(){function s(t,e){this._config=e,this._prepareContainer();var i=o.Event(n);o("body").trigger(i)}var t=s.prototype;return t.create=function(){var t=o('<div class="toast" role="alert" aria-live="assertive" aria-atomic="true"/>');t.data("autohide",this._config.autohide),t.data("animation",this._config.fade),this._config.class&&t.addClass(this._config.class),this._config.delay&&500!=this._config.delay&&t.data("delay",this._config.delay);var e=o('<div class="toast-header">');if(null!=this._config.image){var i=o("<img />").addClass("rounded mr-2").attr("src",this._config.image).attr("alt",this._config.imageAlt);null!=this._config.imageHeight&&i.height(this._config.imageHeight).width("auto"),e.append(i)}if(null!=this._config.icon&&e.append(o("<i />").addClass("mr-2").addClass(this._config.icon)),null!=this._config.title&&e.append(o("<strong />").addClass("mr-auto").html(this._config.title)),null!=this._config.subtitle&&e.append(o("<small />").html(this._config.subtitle)),1==this._config.close){var n=o('<button data-dismiss="toast" />').attr("type","button").addClass("ml-2 mb-1 close").attr("aria-label","Close").append('<span aria-hidden="true">&times;</span>');null==this._config.title&&n.toggleClass("ml-2 ml-auto"),e.append(n)}t.append(e),null!=this._config.body&&t.append(o('<div class="toast-body" />').html(this._config.body)),o(this._getContainerId()).prepend(t);var s=o.Event(a);o("body").trigger(s),t.toast("show"),this._config.autoremove&&t.on("hidden.bs.toast",function(){o(this).delay(200).remove();var t=o.Event(r);o("body").trigger(t)})},t._getContainerId=function(){return this._config.position==l?"#toastsContainerTopRight":this._config.position==c?"#toastsContainerTopLeft":this._config.position==d?"#toastsContainerBottomRight":this._config.position==h?"#toastsContainerBottomLeft":void 0},t._prepareContainer=function(){if(0===o(this._getContainerId()).length){var t=o("<div />").attr("id",this._getContainerId().replace("#",""));this._config.position==l?t.addClass("toasts-top-right"):this._config.position==c?t.addClass("toasts-top-left"):this._config.position==d?t.addClass("toasts-bottom-right"):this._config.position==h&&t.addClass("toasts-bottom-left"),o("body").append(t)}this._config.fixed?o(this._getContainerId()).addClass("fixed"):o(this._getContainerId()).removeClass("fixed")},s._jQueryInterface=function(i,n){return this.each(function(){var t=o.extend({},f,n),e=new s(o(this),t);"create"===i&&e[i]()})},s}(),o.fn[e]=s._jQueryInterface,o.fn[e].Constructor=s,o.fn[e].noConflict=function(){return o.fn[e]=i,s._jQueryInterface},s);t.CardRefresh=ce,t.CardWidget=le,t.ControlSidebar=ie,t.DirectChat=ae,t.Dropdown=de,t.Layout=ne,t.PushMenu=se,t.Toasts=he,t.TodoList=re,t.Treeview=oe,Object.defineProperty(t,"__esModule",{value:!0})});
