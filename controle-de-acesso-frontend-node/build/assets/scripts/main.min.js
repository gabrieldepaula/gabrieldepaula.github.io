...
"use strict";Component.define("form-salvar-morador",function(n,a){var e=$(n).find("form"),o=new URLSearchParams(window.location.search).get("id");o&&$.get(base_api+"morador/pesquisar",function(n){$(n).each(function(n,a){o==a.id&&(e.find('[name="nome"]').val(a.nome),e.find('[name="cpf"]').val(a.cpf),e.find('[name="apartamento"]').val(a.apartamento),e.find('[name="bloco"]').val(a.bloco),e.prepend('<input type="hidden" name="id" value="'+a.id+'">'))})}),e.on("submit",function(n){n.preventDefault(),console.log(e.serialize())})});
"use strict";Component.define("footer",function(e,n){});
"use strict";Component.define("header",function(e,n){});
"use strict";Component.define("page-salvar-morador",function(e,n){});
