...
"use strict";Component.define("page-salvar-acesso",function(a,e){var n=$(a),g=n.find("form"),b=new URLSearchParams(window.location.search).get("id");b?(g.find("input").val("Carregando..."),$.get(base_api+"morador/pesquisar",function(a){$(a).each(function(a,e){b==e.id&&(n.find(".page-title").text("Editar morador #"+b+" - "+e.nome),g.find('[name="nome"]').val(e.nome),g.find('[name="cpf"]').val(e.cpf),g.find('[name="apartamento"]').val(e.apartamento),g.find('[name="bloco"]').val(e.bloco),g.prepend('<input type="hidden" name="id" value="'+e.id+'">'),g.find("input").attr("disabled",!1))})})):g.find("input").attr("disabled",!1),g.on("submit",function(a){a.preventDefault();var e,n=g.find('[name="movimento"]'),i=g.find('[name="tipo"]'),o=g.find('[name="morador"]'),r=g.find('[name="visitante"]'),d=g.find('[name="prestadorservico"]'),s=g.find('[name="corretor"]'),t=g.find('[name="entregador"]'),l=null,p=null,c=null,v=null,f=null;b&&(e=g.find('[name="id"]')),g.find("form-control").removeClass("is-invalid"),g.find(".invalid-feedback").remove();var m=!0;switch(0==n.val().length&&(n.addClass("is-invalid"),n.parents(".form-group").append('<p class="invalid-feedback">Este campo é obrigatório</p>'),m=!1),0==i.val().length&&(i.addClass("is-invalid"),i.parents(".form-group").append('<p class="invalid-feedback">Este campo é obrigatório</p>'),m=!1),i.val()){case"morador":0==o.val().length?(o.addClass("is-invalid"),o.parents(".form-group").append('<p class="invalid-feedback">Este campo é obrigatório</p>'),m=!1):l=o.val();break;case"visitante":0==r.val().length?(r.addClass("is-invalid"),r.parents(".form-group").append('<p class="invalid-feedback">Este campo é obrigatório</p>'),m=!1):p=r.val();break;case"prestadorservico":0==d.val().length?(d.addClass("is-invalid"),d.parents(".form-group").append('<p class="invalid-feedback">Este campo é obrigatório</p>'),m=!1):c=d.val();break;case"corretor":0==s.val().length?(s.addClass("is-invalid"),s.parents(".form-group").append('<p class="invalid-feedback">Este campo é obrigatório</p>'),m=!1):v=s.val();break;case"entregador":0==t.val().length?(t.addClass("is-invalid"),t.parents(".form-group").append('<p class="invalid-feedback">Este campo é obrigatório</p>'),m=!1):f=t.val()}var u={id:b?e.val():null,morador:l,visitante:p,prestadorServico:c,corretor:v,entregador:f,movimento:n.val()};m&&$.ajax({url:base_api+"acesso/salvar",type:"POST",dataType:"json",contentType:"application/json",data:JSON.stringify(u),success:function(){alert("Acesso "+(b?"atualizado":"cadastrado")+" com sucesso."),window.location.href=base},error:function(){alert("Erro na requisição."),window.location.href=window.location.href}})})});
...
"use strict";Component.define("table-acesso",function(e,a){var t={sEmptyTable:"Nenhum registro encontrado",sInfo:"Mostrando de _START_ até _END_ de _TOTAL_ registros",sInfoEmpty:"Mostrando 0 até 0 de 0 registros",sInfoFiltered:"(Filtrados de _MAX_ registros)",sInfoPostFix:"",sInfoThousands:".",sLengthMenu:"Mostrar _MENU_ resultados por página",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sZeroRecords:"Nenhum registro encontrado",sSearch:"Pesquisar",oPaginate:{sNext:"Próximo",sPrevious:"Anterior",sFirst:"Primeiro",sLast:"Último"},oAria:{sSortAscending:": Ordenar colunas de forma ascendente",sSortDescending:": Ordenar colunas de forma descendente"}};$el=$(e);var s=$el.find("#items-table");$.get(base_api+"acesso/pesquisar",function(e){s.find("tbody").html(""),$(e).each(function(e,a){var t="",o="",n="E"==a.movimento?"Entrada":"Saída";a.morador&&(t="Morador",o=a.morador.nome),a.visitante&&(t="Visitante",o=a.visitante.nome),a.prestadorServico&&(t="Prestador de serviço",o=a.prestadorServico.nome),a.corretor&&(t="Corretor",o=a.corretor.nome),a.entregador&&(t="Entregador",o=a.entregador.nome);var r;r="\n            <tr>\n                <td>".concat(a.id,"</td>\n                <td>").concat(t,"</td>\n                <td>").concat(o,"</td>\n                <td>").concat(n,"</td>\n                <td>").concat(a.dataMovimento,'</td>\n                <td style="width:100px;">\n                    <a href="').concat(base,"controle-de-acesso/salvar/?id=").concat(a.id,'" class="btn btn-xs btn-block btn-warning"><i class="fas fa-edit"></i> Editar</a>\n                    <button type="button" class="btn btn-xs btn-block btn-danger" data-action="delete" data-id="').concat(a.id,'"><i class="fas fa-trash"></i> Apagar</a>\n                </td>\n            </tr>\n        '),s.find("tbody").append(r)}),s.DataTable({oLanguage:t,order:[[0,"desc"]],pageLength:25})}),$(document).on("click","[data-action]",function(e){e.preventDefault();var a=$(this),t=a.attr("data-action"),o=a.attr("data-id");switch(t){case"delete":window.confirm("Tem certeza que deseja apagar este acesso?")&&$.ajax({url:base_api+"acesso/apagar/?id="+o,type:"DELETE",success:function(e,a,t){"success"==a?(alert("Acesso excluído com sucesso."),window.location.href=window.location.href):alert("Erro na requisição.")}});break;default:alert("No action defined.")}})});
"use strict";Component.define("table-corretores",function(t,e){var a={sEmptyTable:"Nenhum registro encontrado",sInfo:"Mostrando de _START_ até _END_ de _TOTAL_ registros",sInfoEmpty:"Mostrando 0 até 0 de 0 registros",sInfoFiltered:"(Filtrados de _MAX_ registros)",sInfoPostFix:"",sInfoThousands:".",sLengthMenu:"Mostrar _MENU_ resultados por página",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sZeroRecords:"Nenhum registro encontrado",sSearch:"Pesquisar",oPaginate:{sNext:"Próximo",sPrevious:"Anterior",sFirst:"Primeiro",sLast:"Último"},oAria:{sSortAscending:": Ordenar colunas de forma ascendente",sSortDescending:": Ordenar colunas de forma descendente"}};$el=$(t);var n=$el.find("#items-table");$.get(base_api+"corretor/pesquisar",function(t){n.find("tbody").html(""),$(t).each(function(t,e){var a;a="\n            <tr>\n                <td>".concat(e.id,"</td>\n                <td>").concat(e.nome,"</td>\n                <td>").concat(e.cpf,"</td>\n                <td>").concat(e.dataCadastro,'</td>\n                <td style="width:100px;">\n                    <a href="').concat(base,"corretores/salvar/?id=").concat(e.id,'" class="btn btn-xs btn-block btn-warning"><i class="fas fa-edit"></i> Editar</a>\n                    <button type="button" class="btn btn-xs btn-block btn-danger" data-action="delete" data-id="').concat(e.id,'"><i class="fas fa-trash"></i> Apagar</a>\n                </td>\n            </tr>\n        '),n.find("tbody").append(a)}),n.DataTable({oLanguage:a,order:[[0,"desc"]],pageLength:25})}),$(document).on("click","[data-action]",function(t){t.preventDefault();var e=$(this),a=e.attr("data-action"),n=e.attr("data-id");switch(a){case"delete":window.confirm("Tem certeza que deseja apagar este corretor?")&&$.ajax({url:base_api+"corretor/apagar/?id="+n,type:"DELETE",success:function(t,e,a){"success"==e?(alert("Corretor excluído com sucesso."),window.location.href=window.location.href):alert("Erro na requisição.")}});break;default:alert("No action defined.")}})});
"use strict";Component.define("table-entregadores",function(a,e){var t={sEmptyTable:"Nenhum registro encontrado",sInfo:"Mostrando de _START_ até _END_ de _TOTAL_ registros",sInfoEmpty:"Mostrando 0 até 0 de 0 registros",sInfoFiltered:"(Filtrados de _MAX_ registros)",sInfoPostFix:"",sInfoThousands:".",sLengthMenu:"Mostrar _MENU_ resultados por página",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sZeroRecords:"Nenhum registro encontrado",sSearch:"Pesquisar",oPaginate:{sNext:"Próximo",sPrevious:"Anterior",sFirst:"Primeiro",sLast:"Último"},oAria:{sSortAscending:": Ordenar colunas de forma ascendente",sSortDescending:": Ordenar colunas de forma descendente"}};$el=$(a);var n=$el.find("#items-table");$.get(base_api+"entregador/pesquisar",function(a){n.find("tbody").html(""),$(a).each(function(a,e){var t;t="\n            <tr>\n                <td>".concat(e.id,"</td>\n                <td>").concat(e.nome,"</td>\n                <td>").concat(e.cpf,"</td>\n                <td>").concat(e.dataCadastro,'</td>\n                <td style="width:100px;">\n                    <a href="').concat(base,"entregadores/salvar/?id=").concat(e.id,'" class="btn btn-xs btn-block btn-warning"><i class="fas fa-edit"></i> Editar</a>\n                    <button type="button" class="btn btn-xs btn-block btn-danger" data-action="delete" data-id="').concat(e.id,'"><i class="fas fa-trash"></i> Apagar</a>\n                </td>\n            </tr>\n        '),n.find("tbody").append(t)}),n.DataTable({oLanguage:t,order:[[0,"desc"]],pageLength:25})}),$(document).on("click","[data-action]",function(a){a.preventDefault();var e=$(this),t=e.attr("data-action"),n=e.attr("data-id");switch(t){case"delete":window.confirm("Tem certeza que deseja apagar este entregador?")&&$.ajax({url:base_api+"entregador/apagar/?id="+n,type:"DELETE",success:function(a,e,t){"success"==e?(alert("Entregador excluído com sucesso."),window.location.href=window.location.href):alert("Erro na requisição.")}});break;default:alert("No action defined.")}})});
"use strict";Component.define("table-morador",function(a,t){var e={sEmptyTable:"Nenhum registro encontrado",sInfo:"Mostrando de _START_ até _END_ de _TOTAL_ registros",sInfoEmpty:"Mostrando 0 até 0 de 0 registros",sInfoFiltered:"(Filtrados de _MAX_ registros)",sInfoPostFix:"",sInfoThousands:".",sLengthMenu:"Mostrar _MENU_ resultados por página",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sZeroRecords:"Nenhum registro encontrado",sSearch:"Pesquisar",oPaginate:{sNext:"Próximo",sPrevious:"Anterior",sFirst:"Primeiro",sLast:"Último"},oAria:{sSortAscending:": Ordenar colunas de forma ascendente",sSortDescending:": Ordenar colunas de forma descendente"}};$el=$(a);var n=$el.find("#items-table");$.get(base_api+"morador/pesquisar",function(a){n.find("tbody").html(""),$(a).each(function(a,t){var e;e="\n            <tr>\n                <td>".concat(t.id,"</td>\n                <td>").concat(t.nome,"</td>\n                <td>").concat(t.cpf,"</td>\n                <td>").concat(t.bloco,"</td>\n                <td>").concat(t.apartamento,"</td>\n                <td>").concat(t.dataCadastro,'</td>\n                <td style="width:100px;">\n                    <a href="').concat(base,"moradores/salvar/?id=").concat(t.id,'" class="btn btn-xs btn-block btn-warning"><i class="fas fa-edit"></i> Editar</a>\n                    <button type="button" class="btn btn-xs btn-block btn-danger" data-action="delete" data-id="').concat(t.id,'"><i class="fas fa-trash"></i> Apagar</a>\n                </td>\n            </tr>\n        '),n.find("tbody").append(e)}),n.DataTable({oLanguage:e,order:[[0,"desc"]],pageLength:25})}),$(document).on("click","[data-action]",function(a){a.preventDefault();var t=$(this),e=t.attr("data-action"),n=t.attr("data-id");switch(e){case"delete":window.confirm("Tem certeza que deseja apagar este morador?")&&$.ajax({url:base_api+"morador/apagar/?id="+n,type:"DELETE",success:function(a,t,e){"success"==t?(alert("Morador excluído com sucesso."),window.location.href=window.location.href):alert("Erro na requisição.")}});break;default:alert("No action defined.")}})});
"use strict";Component.define("table-prestador",function(e,a){var t={sEmptyTable:"Nenhum registro encontrado",sInfo:"Mostrando de _START_ até _END_ de _TOTAL_ registros",sInfoEmpty:"Mostrando 0 até 0 de 0 registros",sInfoFiltered:"(Filtrados de _MAX_ registros)",sInfoPostFix:"",sInfoThousands:".",sLengthMenu:"Mostrar _MENU_ resultados por página",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sZeroRecords:"Nenhum registro encontrado",sSearch:"Pesquisar",oPaginate:{sNext:"Próximo",sPrevious:"Anterior",sFirst:"Primeiro",sLast:"Último"},oAria:{sSortAscending:": Ordenar colunas de forma ascendente",sSortDescending:": Ordenar colunas de forma descendente"}};$el=$(e);var s=$el.find("#items-table");$.get(base_api+"prestadorservico/pesquisar",function(e){s.find("tbody").html(""),$(e).each(function(e,a){var t;t="\n            <tr>\n                <td>".concat(a.id,"</td>\n                <td>").concat(a.nome,"</td>\n                <td>").concat(a.cpf,"</td>\n                <td>").concat(a.dataCadastro,'</td>\n                <td style="width:100px;">\n                    <a href="').concat(base,"prestadores-de-servico/salvar/?id=").concat(a.id,'" class="btn btn-xs btn-block btn-warning"><i class="fas fa-edit"></i> Editar</a>\n                    <button type="button" class="btn btn-xs btn-block btn-danger" data-action="delete" data-id="').concat(a.id,'"><i class="fas fa-trash"></i> Apagar</a>\n                </td>\n            </tr>\n        '),s.find("tbody").append(t)}),s.DataTable({oLanguage:t,order:[[0,"desc"]],pageLength:25})}),$(document).on("click","[data-action]",function(e){e.preventDefault();var a=$(this),t=a.attr("data-action"),s=a.attr("data-id");switch(t){case"delete":window.confirm("Tem certeza que deseja apagar este prestador de serviço?")&&$.ajax({url:base_api+"prestadorservico/apagar/?id="+s,type:"DELETE",success:function(e,a,t){"success"==a?(alert("Prestador de serviço excluído com sucesso."),window.location.href=window.location.href):alert("Erro na requisição.")}});break;default:alert("No action defined.")}})});
"use strict";Component.define("table-visitante",function(t,a){var e={sEmptyTable:"Nenhum registro encontrado",sInfo:"Mostrando de _START_ até _END_ de _TOTAL_ registros",sInfoEmpty:"Mostrando 0 até 0 de 0 registros",sInfoFiltered:"(Filtrados de _MAX_ registros)",sInfoPostFix:"",sInfoThousands:".",sLengthMenu:"Mostrar _MENU_ resultados por página",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sZeroRecords:"Nenhum registro encontrado",sSearch:"Pesquisar",oPaginate:{sNext:"Próximo",sPrevious:"Anterior",sFirst:"Primeiro",sLast:"Último"},oAria:{sSortAscending:": Ordenar colunas de forma ascendente",sSortDescending:": Ordenar colunas de forma descendente"}};$el=$(t);var n=$el.find("#items-table");$.get(base_api+"visitante/pesquisar",function(t){n.find("tbody").html(""),$(t).each(function(t,a){var e;e="\n            <tr>\n                <td>".concat(a.id,"</td>\n                <td>").concat(a.nome,"</td>\n                <td>").concat(a.cpf,"</td>\n                <td>").concat(a.dataCadastro,'</td>\n                <td style="width:100px;">\n                    <a href="').concat(base,"visitantes/salvar/?id=").concat(a.id,'" class="btn btn-xs btn-block btn-warning"><i class="fas fa-edit"></i> Editar</a>\n                    <button type="button" class="btn btn-xs btn-block btn-danger" data-action="delete" data-id="').concat(a.id,'"><i class="fas fa-trash"></i> Apagar</a>\n                </td>\n            </tr>\n        '),n.find("tbody").append(e)}),n.DataTable({oLanguage:e,order:[[0,"desc"]],pageLength:25})}),$(document).on("click","[data-action]",function(t){t.preventDefault();var a=$(this),e=a.attr("data-action"),n=a.attr("data-id");switch(e){case"delete":window.confirm("Tem certeza que deseja apagar este visitante?")&&$.ajax({url:base_api+"visitante/apagar/?id="+n,type:"DELETE",success:function(t,a,e){"success"==a?(alert("Visitante excluído com sucesso."),window.location.href=window.location.href):alert("Erro na requisição.")}});break;default:alert("No action defined.")}})});
