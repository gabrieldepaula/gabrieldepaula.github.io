...
"use strict";Component.define("table",function(t,e){var n={sEmptyTable:"Nenhum registro encontrado",sInfo:"Mostrando de _START_ até _END_ de _TOTAL_ registros",sInfoEmpty:"Mostrando 0 até 0 de 0 registros",sInfoFiltered:"(Filtrados de _MAX_ registros)",sInfoPostFix:"",sInfoThousands:".",sLengthMenu:"Mostrar _MENU_ resultados por página",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sZeroRecords:"Nenhum registro encontrado",sSearch:"Pesquisar",oPaginate:{sNext:"Próximo",sPrevious:"Anterior",sFirst:"Primeiro",sLast:"Último"},oAria:{sSortAscending:": Ordenar colunas de forma ascendente",sSortDescending:": Ordenar colunas de forma descendente"}};$el=$(t);var s=$el.find("#items-table");$.get("https://gl-controle-de-acesso.herokuapp.com/morador/pesquisar",function(t){s.find("tbody").html(""),$(t).each(function(t,n){var o="";switch(e.entity){case"moradores":o="\n                    <tr>\n                        <td>".concat(n.id,"</td>\n                        <td>").concat(n.nome,"</td>\n                        <td>").concat(n.cpf,"</td>\n                        <td>").concat(n.bloco,"</td>\n                        <td>").concat(n.apartamento,"</td>\n                        <td>").concat(n.dataCadastro,'</td>\n                        <td>\n                            <button type="button" class="btn btn-xs btn-warning"><i class="fas fa-edit"></i> Editar</button>\n                        </td>\n                    </tr>\n                ')}s.find("tbody").append(o)}),s.DataTable({oLanguage:n,order:[[0,"desc"]],pageLength:25})})});
