...
"use strict";Component.define("page-salvar-acesso",function(a,e){var n=$(a),f=n.find("form"),v=new URLSearchParams(window.location.search).get("id");v?(f.find("input").val("Carregando..."),$.get(base_api+"morador/pesquisar",function(a){$(a).each(function(a,e){v==e.id&&(n.find(".page-title").text("Editar morador #"+v+" - "+e.nome),f.find('[name="nome"]').val(e.nome),f.find('[name="cpf"]').val(e.cpf),f.find('[name="apartamento"]').val(e.apartamento),f.find('[name="bloco"]').val(e.bloco),f.prepend('<input type="hidden" name="id" value="'+e.id+'">'),f.find("input").attr("disabled",!1))})})):f.find("input").attr("disabled",!1),f.on("submit",function(a){a.preventDefault();var e,n=f.find('[name="movimento"]'),i=f.find('[name="tipo"]'),o=f.find('[name="morador"]'),r=f.find('[name="visitante"]'),d=f.find('[name="prestadorservico"]'),t=(f.find('[name="corretor"]'),f.find('[name="entregador"]'),null),s=null,l=null;v&&(e=f.find('[name="id"]')),f.find("form-control").removeClass("is-invalid"),f.find(".invalid-feedback").remove();var p=!0;switch(0==n.val().length&&(n.addClass("is-invalid"),n.parents(".form-group").append('<p class="invalid-feedback">Este campo é obrigatório</p>'),p=!1),0==i.val().length&&(i.addClass("is-invalid"),i.parents(".form-group").append('<p class="invalid-feedback">Este campo é obrigatório</p>'),p=!1),i.val()){case"morador":0==o.val().length?(o.addClass("is-invalid"),o.parents(".form-group").append('<p class="invalid-feedback">Este campo é obrigatório</p>'),p=!1):t=o.val();break;case"visitante":0==r.val().length?(r.addClass("is-invalid"),r.parents(".form-group").append('<p class="invalid-feedback">Este campo é obrigatório</p>'),p=!1):s=r.val();break;case"prestadorservico":0==d.val().length?(d.addClass("is-invalid"),d.parents(".form-group").append('<p class="invalid-feedback">Este campo é obrigatório</p>'),p=!1):l=d.val()}var c={id:v?e.val():null,morador:t,visitante:s,prestadorServico:l,movimento:n.val()};p&&$.ajax({url:base_api+"acesso/salvar",type:"POST",dataType:"json",contentType:"application/json",data:JSON.stringify(c),success:function(){alert("Acesso "+(v?"atualizado":"cadastrado")+" com sucesso."),window.location.href=base},error:function(){alert("Erro na requisição."),window.location.href=window.location.href}})})});
