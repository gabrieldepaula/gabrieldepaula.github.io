...
"use strict";Component.define("table-entregadores",function(e,t){var a={sEmptyTable:"Nenhum registro encontrado",sInfo:"Mostrando de _START_ até _END_ de _TOTAL_ registros",sInfoEmpty:"Mostrando 0 até 0 de 0 registros",sInfoFiltered:"(Filtrados de _MAX_ registros)",sInfoPostFix:"",sInfoThousands:".",sLengthMenu:"Mostrar _MENU_ resultados por página",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sZeroRecords:"Nenhum registro encontrado",sSearch:"Pesquisar",oPaginate:{sNext:"Próximo",sPrevious:"Anterior",sFirst:"Primeiro",sLast:"Último"},oAria:{sSortAscending:": Ordenar colunas de forma ascendente",sSortDescending:": Ordenar colunas de forma descendente"}};$el=$(e);var n=$el.find("#items-table");$.get(base_api+"entregador/pesquisar",function(e){n.find("tbody").html(""),$(e).each(function(e,t){var a;a="\n            <tr>\n                <td>".concat(t.id,"</td>\n                <td>").concat(t.nome,"</td>\n                <td>").concat(t.cpf,"</td>\n                <td>").concat(t.dataCadastro,'</td>\n                <td style="width:100px;">\n                    <a href="').concat(base,"entregadores/salvar/?id=").concat(t.id,'" class="btn btn-xs btn-block btn-warning"><i class="fas fa-edit"></i> Editar</a>\n                    <button type="button" class="btn btn-xs btn-block btn-danger" data-action="delete" data-id="').concat(t.id,'"><i class="fas fa-trash"></i> Exluir</a>\n                </td>\n            </tr>\n        '),n.find("tbody").append(a)}),n.DataTable({oLanguage:a,order:[[0,"desc"]],pageLength:25})}),$(document).on("click","[data-action]",function(e){e.preventDefault();var t=$(this),a=t.attr("data-action"),n=t.attr("data-id");switch(a){case"delete":window.confirm("Tem certeza que deseja apagar este entregador?")&&$.ajax({url:base_api+"entregador/apagar/?id="+n,type:"DELETE",success:function(e,t,a){"success"==t?(alert("Entregador excluído com sucesso."),window.location.href=window.location.href):alert("Erro na requisição.")}});break;default:alert("No action defined.")}})});
...
"use strict";Component.define("table-prestador",function(e,t){var a={sEmptyTable:"Nenhum registro encontrado",sInfo:"Mostrando de _START_ até _END_ de _TOTAL_ registros",sInfoEmpty:"Mostrando 0 até 0 de 0 registros",sInfoFiltered:"(Filtrados de _MAX_ registros)",sInfoPostFix:"",sInfoThousands:".",sLengthMenu:"Mostrar _MENU_ resultados por página",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sZeroRecords:"Nenhum registro encontrado",sSearch:"Pesquisar",oPaginate:{sNext:"Próximo",sPrevious:"Anterior",sFirst:"Primeiro",sLast:"Último"},oAria:{sSortAscending:": Ordenar colunas de forma ascendente",sSortDescending:": Ordenar colunas de forma descendente"}};$el=$(e);var s=$el.find("#items-table");$.get(base_api+"prestadorservico/pesquisar",function(e){s.find("tbody").html(""),$(e).each(function(e,t){var a;a="\n            <tr>\n                <td>".concat(t.id,"</td>\n                <td>").concat(t.nome,"</td>\n                <td>").concat(t.cpf,"</td>\n                <td>").concat(t.dataCadastro,'</td>\n                <td style="width:100px;">\n                    <a href="').concat(base,"prestadores-de-servico/salvar/?id=").concat(t.id,'" class="btn btn-xs btn-block btn-warning"><i class="fas fa-edit"></i> Editar</a>\n                    <button type="button" class="btn btn-xs btn-block btn-danger" data-action="delete" data-id="').concat(t.id,'"><i class="fas fa-trash"></i> Exluir</a>\n                </td>\n            </tr>\n        '),s.find("tbody").append(a)}),s.DataTable({oLanguage:a,order:[[0,"desc"]],pageLength:25})}),$(document).on("click","[data-action]",function(e){e.preventDefault();var t=$(this),a=t.attr("data-action"),s=t.attr("data-id");switch(a){case"delete":window.confirm("Tem certeza que deseja apagar este prestador de serviço?")&&$.ajax({url:base_api+"prestadorservico/apagar/?id="+s,type:"DELETE",success:function(e,t,a){"success"==t?(alert("Prestador de serviço excluído com sucesso."),window.location.href=window.location.href):alert("Erro na requisição.")}});break;default:alert("No action defined.")}})});
"use strict";Component.define("table-visitante",function(t,a){var e={sEmptyTable:"Nenhum registro encontrado",sInfo:"Mostrando de _START_ até _END_ de _TOTAL_ registros",sInfoEmpty:"Mostrando 0 até 0 de 0 registros",sInfoFiltered:"(Filtrados de _MAX_ registros)",sInfoPostFix:"",sInfoThousands:".",sLengthMenu:"Mostrar _MENU_ resultados por página",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sZeroRecords:"Nenhum registro encontrado",sSearch:"Pesquisar",oPaginate:{sNext:"Próximo",sPrevious:"Anterior",sFirst:"Primeiro",sLast:"Último"},oAria:{sSortAscending:": Ordenar colunas de forma ascendente",sSortDescending:": Ordenar colunas de forma descendente"}};$el=$(t);var n=$el.find("#items-table");$.get(base_api+"visitante/pesquisar",function(t){n.find("tbody").html(""),$(t).each(function(t,a){var e;e="\n            <tr>\n                <td>".concat(a.id,"</td>\n                <td>").concat(a.nome,"</td>\n                <td>").concat(a.cpf,"</td>\n                <td>").concat(a.dataCadastro,'</td>\n                <td style="width:100px;">\n                    <a href="').concat(base,"visitantes/salvar/?id=").concat(a.id,'" class="btn btn-xs btn-block btn-warning"><i class="fas fa-edit"></i> Editar</a>\n                    <button type="button" class="btn btn-xs btn-block btn-danger" data-action="delete" data-id="').concat(a.id,'"><i class="fas fa-trash"></i> Exluir</a>\n                </td>\n            </tr>\n        '),n.find("tbody").append(e)}),n.DataTable({oLanguage:e,order:[[0,"desc"]],pageLength:25})}),$(document).on("click","[data-action]",function(t){t.preventDefault();var a=$(this),e=a.attr("data-action"),n=a.attr("data-id");switch(e){case"delete":window.confirm("Tem certeza que deseja apagar este visitante?")&&$.ajax({url:base_api+"visitante/apagar/?id="+n,type:"DELETE",success:function(t,a,e){"success"==a?(alert("Visitante excluído com sucesso."),window.location.href=window.location.href):alert("Erro na requisição.")}});break;default:alert("No action defined.")}})});
