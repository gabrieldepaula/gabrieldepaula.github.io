...
"use strict";Component.define("table-acesso",function(a,e){var t={sEmptyTable:"Nenhum registro encontrado",sInfo:"Mostrando de _START_ até _END_ de _TOTAL_ registros",sInfoEmpty:"Mostrando 0 até 0 de 0 registros",sInfoFiltered:"(Filtrados de _MAX_ registros)",sInfoPostFix:"",sInfoThousands:".",sLengthMenu:"Mostrar _MENU_ resultados por página",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sZeroRecords:"Nenhum registro encontrado",sSearch:"Pesquisar",oPaginate:{sNext:"Próximo",sPrevious:"Anterior",sFirst:"Primeiro",sLast:"Último"},oAria:{sSortAscending:": Ordenar colunas de forma ascendente",sSortDescending:": Ordenar colunas de forma descendente"}};$el=$(a);var r=$el.find("#items-table");$.get(base_api+"acesso/pesquisar",function(a){r.find("tbody").html(""),$(a).each(function(a,e){var t="",o="",n="E"==e.movimento?"Entrada":"Saída";e.morador&&(t="Morador",o=e.morador.nome),e.visitante&&(t="Visitante",o=e.visitante.nome),e.prestadorServico&&(t="Prestador de serviço",o=e.prestadorServico.nome);var s;s="\n            <tr>\n                <td>".concat(e.id,"</td>\n                <td>").concat(t,"</td>\n                <td>").concat(o,"</td>\n                <td>").concat(n,"</td>\n                <td>").concat(e.dataMovimento,'</td>\n                <td style="width:100px;">\n                    <a href="').concat(base,"controle-de-acesso/salvar/?id=").concat(e.id,'" class="btn btn-xs btn-block btn-warning"><i class="fas fa-edit"></i> Editar</a>\n                    <button type="button" class="btn btn-xs btn-block btn-danger" data-action="delete" data-id="').concat(e.id,'"><i class="fas fa-trash"></i> Apagar</a>\n                </td>\n            </tr>\n        '),r.find("tbody").append(s)}),r.DataTable({oLanguage:t,order:[[0,"desc"]],pageLength:25})}),$(document).on("click","[data-action]",function(a){a.preventDefault();var e=$(this),t=e.attr("data-action"),o=e.attr("data-id");switch(t){case"delete":window.confirm("Tem certeza que deseja apagar este acesso?")&&$.ajax({url:base_api+"acesso/apagar/?id="+o,type:"DELETE",success:function(a,e,t){"success"==e?(alert("Acesso excluído com sucesso."),window.location.href=window.location.href):alert("Erro na requisição.")}});break;default:alert("No action defined.")}})});
