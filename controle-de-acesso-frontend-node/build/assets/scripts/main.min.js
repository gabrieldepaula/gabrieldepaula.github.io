...
"use strict";Component.define("form-salvar-morador",function(o,n){var e=$(o).find("form");e.on("submit",function(o){o.preventDefault(),console.log(e.serialize())})});
"use strict";Component.define("header",function(e,n){});
"use strict";Component.define("page-salvar-morador",function(a,e){var n=$(a),o=n.find("form"),i=new URLSearchParams(window.location.search).get("id");i&&$.get(base_api+"morador/pesquisar",function(a){$(a).each(function(a,e){i==e.id&&(n.find(".page-title").text("Editar morador #"+i+" - "+e.nome),o.find('[name="nome"]').val(e.nome),o.find('[name="cpf"]').val(e.cpf),o.find('[name="apartamento"]').val(e.apartamento),o.find('[name="bloco"]').val(e.bloco),o.prepend('<input type="hidden" name="id" value="'+e.id+'">'))})})});
"use strict";Component.define("player",function(e,n){});
"use strict";Component.define("table",function(t,n){var a={sEmptyTable:"Nenhum registro encontrado",sInfo:"Mostrando de _START_ até _END_ de _TOTAL_ registros",sInfoEmpty:"Mostrando 0 até 0 de 0 registros",sInfoFiltered:"(Filtrados de _MAX_ registros)",sInfoPostFix:"",sInfoThousands:".",sLengthMenu:"Mostrar _MENU_ resultados por página",sLoadingRecords:"Carregando...",sProcessing:"Processando...",sZeroRecords:"Nenhum registro encontrado",sSearch:"Pesquisar",oPaginate:{sNext:"Próximo",sPrevious:"Anterior",sFirst:"Primeiro",sLast:"Último"},oAria:{sSortAscending:": Ordenar colunas de forma ascendente",sSortDescending:": Ordenar colunas de forma descendente"}};$el=$(t);var o=$el.find("#items-table");$.get(base_api+"morador/pesquisar",function(t){o.find("tbody").html(""),$(t).each(function(t,a){var e="";switch(n.entity){case"moradores":e="\n                    <tr>\n                        <td>".concat(a.id,"</td>\n                        <td>").concat(a.nome,"</td>\n                        <td>").concat(a.cpf,"</td>\n                        <td>").concat(a.bloco,"</td>\n                        <td>").concat(a.apartamento,"</td>\n                        <td>").concat(a.dataCadastro,'</td>\n                        <td style="width:100px;">\n                            <a href="').concat(base,"moradores/salvar/?id=").concat(a.id,'" class="btn btn-xs btn-block btn-warning"><i class="fas fa-edit"></i> Editar</a>\n                            <button type="button" class="btn btn-xs btn-block btn-danger" data-action="delete" data-id="').concat(a.id,'"><i class="fas fa-trash"></i> Exluir</a>\n                        </td>\n                    </tr>\n                ')}o.find("tbody").append(e)}),o.DataTable({oLanguage:a,order:[[0,"desc"]],pageLength:25})}),$(document).on("click","[data-action]",function(t){t.preventDefault();var a=$(this),e=a.attr("data-action"),n=a.attr("data-id");switch(e){case"delete":window.confirm("Tem certeza que deseja apagar este morador?")&&$.ajax({url:base_api+"morador/apagar/?id="+n,type:"DELETE",success:function(t){console.log(t)}});break;default:alert("Erro")}})});
